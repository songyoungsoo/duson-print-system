    ...
    <script>
        ...
        function staffLogin() {
            ...
            if (currentStaffId) {
                ...
                sessionStorage.setItem('user_name', select.options[select.selectedIndex].text);
        ...
        function appendAdminMessage(msg) {
            ...
            messageDiv.innerHTML = `
                ...
                <div class="message-content">
                    ${!isSent && !isSystem ? `<div class="message-sender">${msg.sendername}</div>` : ''}
                    ${contentHtml}
