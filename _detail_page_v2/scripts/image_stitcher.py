"""
이미지 합치기 스크립트 V2
13개 섹션 이미지를 하나의 긴 상세페이지로 합침
V2: 1100x800 이미지 13장 → 1100x10400 최종 이미지
"""
...
def validate_sections(
    sections_dir: str, expected_count: int = 13, expected_height: int = 800
) -> dict:
    """섹션 이미지 품질 검증"""
    sections_path = Path(sections_dir)
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 3:
        ...
        print(
            "예시: python image_stitcher.py output/namecard/ko/sections output/namecard/ko/final_detail_page.png"
        )
        sys.exit(1)
