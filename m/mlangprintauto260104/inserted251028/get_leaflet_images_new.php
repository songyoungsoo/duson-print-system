<?php
/**
 * 전단지 포트폴리오 이미지 API - ImgFolder 경로 사용 버전
 * ImgFolder/inserted/gallery/ 경로에서 이미지를 가져옴
 */
...
try {
    ...
    // ImgFolder 갤러리 경로
    $galleryPath = $_SERVER['DOCUMENT_ROOT'] . '/ImgFolder/inserted/gallery/';
    $webPath = '/ImgFolder/inserted/gallery/';
    ...
    if (is_dir($galleryPath)) {
        ...
        for ($i = 1; $i <= 4; $i++) {
            $images[] = [
                'id' => 'sample_' . $i,
                'title' => '전단지 샘플 ' . $i,
                'filename' => 'leaflet_sample_' . $i . '.jpg',
                'path' => '/images/samples/leaflet_sample_' . $i . '.jpg',
                'image_path' => '/images/samples/leaflet_sample_' . $i . '.jpg',
                'thumbnail' => '/images/samples/leaflet_sample_' . $i . '.jpg',
                'thumbnail_path' => '/images/samples/leaflet_sample_' . $i . '.jpg',
                'thumb_path' => '/images/samples/leaflet_sample_' . $i . '.jpg',
                'url' => '/images/samples/leaflet_sample_' . $i . '.jpg',
                'thumb' => '/images/samples/leaflet_sample_' . $i . '.jpg',
                'category' => '전단지',
                'is_default' => true
            ];
        }
