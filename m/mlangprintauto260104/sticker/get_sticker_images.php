 ...
 * ImgFolder/sticker/gallery/ 경로에서 이미지를 가져옴
 */
...
try {
    $category = isset($_GET['category']) ? $_GET['category'] : 'sticker';
    ...
    if (empty($images)) {
        ...
        for ($i = 1; $i <= 4; $i++) {
            $images[] = [
                ...
                'path' => '/images/samples/sticker_sample_' . $i . '.jpg',
                'image_path' => '/images/samples/sticker_sample_' . $i . '.jpg',
                'thumbnail' => '/images/samples/sticker_sample_' . $i . '.jpg',
                'thumbnail_path' => '/images/samples/sticker_sample_' . $i . '.jpg',
                'thumb_path' => '/images/samples/sticker_sample_' . $i . '.jpg',
                'url' => '/images/samples/sticker_sample_' . $i . '.jpg',
                'thumb' => '/images/samples/sticker_sample_' . $i . '.jpg',
                'category' => '스티커',
                'is_default' => true
            ];
        }
