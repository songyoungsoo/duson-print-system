...
// 배열 기반 바인딩 (PHP 호환성 개선)
// 15 params: quotation_no(s) + public_token(s) + session_id(s) + customer_name(s) + customer_email(s) +
...
if (!$bind_result) {
    jsonError('바인딩 실패: ' . mysqli_stmt_error($stmt), 500);
}
