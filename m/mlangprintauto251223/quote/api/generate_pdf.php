        ...
        <table class="items-table">
            <thead>
                <tr>
                    ...
                    <th style="width: 30%;">규격/옵션</th>
                    <th style="width: 12%;">수량</th>
                    <th style="width: 10%;">단위</th>
                    <th style="width: 28%;">총액</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td class="right" style="font-weight: 600;">
                        <?php echo number_format($item['total_price']); ?> 원
                    </td>
                </tr>
                <?php endforeach; ?>
            ...
            <tfoot>
                <tr>
                    <td colspan="5" style="text-align: right; font-weight: bold; background: #f0f0f0; font-size: 14px;">총 합계</td>
                    <td class="right" style="font-weight: bold; font-size: 14px;"><?php echo number_format($quote['grand_total']); ?> 원</td>
                </tr>
            </tfoot>
        </table>
