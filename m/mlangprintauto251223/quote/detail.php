...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .col-total { width: 25%; text-align: right; font-weight: bold; font-family: 'Noto Sans KR', sans-serif; }
                        ...
                        <table class="excel-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="col-total" style="text-align: right; font-weight: 600;">
