        ...
        <div class="print-container">
            ...
            <div class="print-order">
                ...
                <div class="print-info-section">
                    ...
                    <!-- 주문 상세 표 (단일/그룹 모두 표시) -->
                    <table style="width: 100%; border-collapse: collapse; margin-bottom: 3mm; font-size: 10pt; table-layout: fixed;">
                        <colgroup>
                            <col style="width: 5%;">
                            <col style="width: 12%;">
                            <col style="width: 40%;">
                        ...
                        <thead>
                            <tr style="background-color: #f5f5f5; border: 0.3pt solid #000;">
                                <th style="border: 0.3pt solid #000; padding: 1.5mm; text-align: center;">NO</th>
                                <th style="border: 0.3pt solid #000; padding: 1.5mm; text-align: center;">품 목</th>
                                <th style="border: 0.3pt solid #000; padding: 1.5mm; text-align: center;">규격/옵션</th>
                                <th style="border: 0.3pt solid #000; padding: 1.5mm; text-align: center;">수량</th>
                                <th style="border: 0.3pt solid #000; padding: 1.5mm; text-align: center;">단위</th>
                                <th style="border: 0.3pt solid #000; padding: 1.5mm; text-align: right;">인쇄비</th>
                                <th style="border: 0.3pt solid #000; padding: 1.5mm; text-align: right;">공급가액</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
    ...
    <div class="screen-only">
        <div class="admin-container" style="width: 700px; max-width: 100%; margin: 0 auto; padding: 15px; background: #fff; box-sizing: border-box;">
            ...
            <form name='JoinInfo' method='post' enctype='multipart/form-data' onsubmit='return JoinCheckField()' action='/admin/mlangprintauto/admin.php' style="width: 100%; margin: 0; padding: 0;">
                ...
                <!-- ===== 주문 상품 테이블 ===== -->
                <table style="width: 100%; border-collapse: collapse; margin-bottom: 15px; border: 2px solid #333; table-layout: fixed;">
                    <colgroup>
                        <col style="width: 5%;">
                        <col style="width: 12%;">
                        <col style="width: 40%;">
