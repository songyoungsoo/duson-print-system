...
mysqli_stmt_bind_param($stmt, "ssssssissiiis",
    $quotation_no,
    $session_id,
    $customerName,
    $recipientEmail,
...
foreach ($cart_items as $item) {
    ...
    $itemRows .= "<tr>
        ...
        <td style='border: 1px solid #000; padding: 6px; text-align: right;'>" . number_format($price) . "</td>
...
<body style="font-family: '맑은 고딕', 'Malgun Gothic', sans-serif; padding: 20px; max-width: 800px; margin: 0 auto;">
        ...
        <tr>
            <td style="width: 50%; vertical-align: top;">
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td style="border: 1px solid #000; padding: 6px; background: #f5f5f5;">담당자</td>
    ...
    <table style="width: 100%; text-align: center; margin-bottom: 20px; border: 2px solid #000;">
        <tr>
            <td style="padding: 15px; font-size: 18px;">
                ...
                <span style="font-size: 22px; color: #c00;">{$koreanTotal}</span>
