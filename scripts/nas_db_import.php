<?php
/**
 * NAS DB Import Script
 * delta SQL(스키마+데이터)을 NAS MySQL에 import
 * 호출: http://dsp1830.ipdisk.co.kr:8000/db_import.php?key=duson_nas_2026
 */

$SECRET_KEY = 'duson_nas_2026';
$DELTA_FILE = '/mnt/HDD2/share/db_backups/delta_orders.sql';
$DB_HOST    = 'localhost';
$DB_USER    = 'dsp1830';
$DB_PASS    = 'ds701018';
$DB_NAME    = 'dsp1830';
