<?php
/**
 * 리플렛 포트폴리오 이미지 API - ImgFolder 갤러리 통합 버전
 * ImgFolder/leaflet/gallery/ 경로에서 이미지를 가져옴
 */
...
try {
    $category = isset($_GET['category']) ? $_GET['category'] : 'leaflet';
