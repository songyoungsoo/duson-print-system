...
// 프리미엄 옵션 총액 받기 (명함 방식 적용)
$premium_options_total = intval($_GET['premium_options_total'] ?? 0);
...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    // 프리미엄 옵션 포함하여 총 가격 계산
    $total_price = $base_price + $design_price + $premium_options_total;
