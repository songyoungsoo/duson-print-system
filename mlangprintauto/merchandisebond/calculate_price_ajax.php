...
// 프리미엄 옵션 총액 처리
$premium_options_total = intval($params['premium_options_total'] ?? 0);
if ($premium_options_total > 0) {
    $params['additional_options_total'] = $premium_options_total;
}

// 중앙 서비스로 가격 계산
$service = new PriceCalculationService($db);
$result = $service->calculate('merchandisebond', $params);
