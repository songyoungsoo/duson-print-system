...
<head>
    ...
    <title>견적서_<?php echo htmlspecialchars($quote['customer_name']); ?>_<?php echo htmlspecialchars($quote['quotation_no']); ?></title>
...
<body>
    ...
    <div class="quote-paper">
        <div class="quote-no">No. <?php echo htmlspecialchars($quote['quotation_no']); ?></div>
