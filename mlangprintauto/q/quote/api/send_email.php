...
// PHPMailer 로드
require_once $_SERVER['DOCUMENT_ROOT'] . '/mlangorder_printauto/PHPMailer/PHPMailer.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/mlangorder_printauto/PHPMailer/SMTP.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/mlangorder_printauto/PHPMailer/Exception.php';
...
function sendQuotationEmail($db, $quoteId, $recipientEmail, $recipientName = '', $ccEmail = '') {
    ...
    try {
        ...
        foreach ($items as $item) {
            ...
            $unitPriceResult = calcUnitPrice($item['supply_price'], $qty);
            $unitPriceFmt = $unitPriceResult['valid'] ? $unitPriceResult['display'] : '-';
