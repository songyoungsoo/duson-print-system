...
<head>
    ...
    <link rel="canonical" href="https://dsp114.com/mlangprintauto/ncrflambeau/">
...
<body class="ncrflambeau-page<?php echo ($isQuotationMode || $isAdminQuoteMode) ? ' quotation-modal-mode' : ''; ?>" <?php ThemeLoader::renderBodyAttributes(); ?>>
    ...
    <?php $detail_page_product = 'ncrflambeau'; include __DIR__ . "/../../_detail_page/detail_page_loader.php"; ?>
    <!-- NCR양식지 상세 설명 섹션 (1100px 폭) - 하단 설명방법 적용 -->
