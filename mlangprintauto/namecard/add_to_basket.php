...
// 🔧 FIX: 21개 필드에 맞는 타입 문자열 (21자)
// 1-6: s,s,s,s,s,s (session~MY_amount) = 6개
// 7-9: d,s,s (quantity=실수, unit, ordertype) = 3개
// 10-11: i,i (st_price, st_price_vat) = 2개
// 12-13: s,i (premium_options=JSON, premium_options_total=INT) = 2개
// 14-21: s,s,s,s,s,s,s,s (옵션명~ImgFolder) = 8개
mysqli_stmt_bind_param($stmt, "ssssssdssiisissssssss",
    $session_id, $product_type, $MY_type, $Section, $POtype, $MY_amount, $quantity, $unit, $ordertype,
