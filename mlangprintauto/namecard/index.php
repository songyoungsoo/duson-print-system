...
<body class="namecard-page<?php echo $body_class; ?>">
    ...
    <script>
        ...
        window.sendToQuotation = function() {
            ...
            // 가격 계산 확인
            if (!window.currentPriceData || !window.currentPriceData.total_supply_price) {
            ...
            try {
                ...
                // 규격 문자열 생성
                const specification = `${typeText} / ${sectionText} / ${potypeText} / ${quantityText} / ${ordertypeText}`.trim();
                ...
                const quotationData = {
                    ...
                    unit: '개',
                    supply_price: parseInt(window.currentPriceData.total_supply_price) || 0,
                    vat_price: parseInt(window.currentPriceData.final_total_with_vat) || 0,
