...
<body>
    ...
    <div class="compact-container">
        <div class="page-title">
            <h1>💳 명함 견적안내 <span style="color: #d4af37; font-size: 0.8em;">[프리미엄 옵션 개발버전]</span></h1>
            <p><!-- 박, 넘버링, 미싱, 귀돌이, 오시 등 프리미엄 옵션 추가 --></p>
        </div>
                    ...
                    <div class="namecard-premium-options-section" id="premiumOptionsSection" style="margin-top: 15px;">
                        ...
                        <div class="option-details" id="foil_options" style="display: none;">
                            <select name="foil_type" id="foil_type" class="option-select">
                                <option value="gold_matte">금박무광 (500매 이하 30,000원)</option>
                                <option value="gold_gloss">금박유광 (500매 이하 30,000원)</option>
                                <option value="silver_matte">은박무광 (500매 이하 30,000원)</option>
                                <option value="silver_gloss">은박유광 (500매 이하 30,000원)</option>
                                <option value="blue_gloss">청박유광 (500매 이하 30,000원)</option>
                                <option value="red_gloss">적박유광 (500매 이하 30,000원)</option>
                                <option value="green_gloss">녹박유광 (500매 이하 30,000원)</option>
                                <option value="black_gloss">먹박유광 (500매 이하 30,000원)</option>
                            </select>
                        </div>
                        ...
                        <div class="option-details" id="numbering_options" style="display: none;">
                            <select name="numbering_type" id="numbering_type" class="option-select">
                                <option value="single">1개 (500매 이하 60,000원)</option>
                                <option value="double">2개 (500매 이하 75,000원, +15,000원)</option>
                            </select>
                        </div>
                        ...
                        <div class="option-details" id="perforation_options" style="display: none;">
                            <select name="perforation_type" id="perforation_type" class="option-select">
                                <option value="single">1개 (500매 이하 20,000원)</option>
                                <option value="double">2개 (500매 이하 35,000원, +15,000원)</option>
                            </select>
                        </div>
                        ...
                        <div class="option-details" id="creasing_options" style="display: none;">
                            <select name="creasing_type" id="creasing_type" class="option-select">
                                <option value="1line">1줄 (500매 이하 20,000원)</option>
                                <option value="2line">2줄 (500매 이하 20,000원)</option>
                                <option value="3line">3줄 (500매 이하 35,000원, +15,000원)</option>
                            </select>
                        </div>
    ...
    <script>
        ...
        function calculatePremiumOptions() {
            ...
            if (foilEnabled) {
                const price = calculateIndividualPrice('foil', quantity, 30000, 12);
            ...
            if (numberingEnabled) {
                ...
                const basePrice = type === 'double' ? 75000 : 60000;
                const price = calculateIndividualPrice('numbering', quantity, basePrice, 12);
            ...
            if (document.getElementById('perforation_enabled')?.checked) {
                ...
                const basePrice = type === 'double' ? 35000 : 20000;
            ...
            if (document.getElementById('rounding_enabled')?.checked) {
                const price = calculateIndividualPrice('rounding', quantity, 6000, 12);
            ...
            if (document.getElementById('creasing_enabled')?.checked) {
                ...
                const basePrice = type === '3line' ? 35000 : 20000;
