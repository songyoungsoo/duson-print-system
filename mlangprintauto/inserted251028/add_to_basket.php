...
if ($stmt) {
    ...
    error_log("coating_enabled: $coating_enabled, coating_type: $coating_type, coating_price: $coating_price");
    error_log("folding_enabled: $folding_enabled, folding_type: $folding_type, folding_price: $folding_price");
    error_log("creasing_enabled: $creasing_enabled, creasing_lines: $creasing_lines, creasing_price: $creasing_price");
