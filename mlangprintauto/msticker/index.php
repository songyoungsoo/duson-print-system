...
<body class="msticker-page<?php echo $body_class; ?>">
...
<?php endif; ?>
            ...
            <div class="product-calculator">
                ...
                <form id="mstickerForm">
                    ...
                    <div class="upload-order-button" id="uploadOrderButton" style="<?php echo $is_quotation_mode ? 'display: none;' : ''; ?>">
                        <?php if ($is_quotation_mode): ?>
...
<?php endif; ?>
    ...
    <script>
        ...
        window.phpVars = {
            ...
            page: "msticker",
            isQuotationMode: <?php echo $is_quotation_mode ? 'true' : 'false'; ?>,
            defaultValues: {
        ...
        // 통일된 갤러리 팝업 초기화 (견적서 모드에서는 비활성화)
        let unifiedMstickerGallery;

        // 페이지 로드 시 초기화
        document.addEventListener('DOMContentLoaded', function() {
            // 견적서 모드에서는 갤러리 초기화 건너뛰기
            if (window.phpVars && window.phpVars.isQuotationMode) {
                console.log('📋 견적서 모드: 갤러리 초기화 건너뛰기');
                return;
            }
