...
<?php endif; ?>
    ...
    <script>
        ...
        function areAllOptionsSelected() {
            ...
            const result = jong && garo > 0 && sero > 0 && mesu && uhyung && domusong;
            console.log('areAllOptionsSelected:', {jong, garo, sero, mesu, uhyung, domusong, result});
            return result;
        }
        ...
        function autoCalculatePrice() {
            ...
            // action 파라미터 추가 (calculate_price.php에서 필수)
