...
if ($price_result) {
    // 추가 옵션 포함하여 총 가격 재계산
    $total_price_with_options = $price_result['total_price'] + $additional_options_total;
    $total_with_vat_with_options = $total_price_with_options * 1.1;
    ...
    $response_data = [
        ...
        'vat' => ($total_price_with_options * 0.1),
        ...
        'Order_Price' => format_number($total_price_with_options),
        'PriceForm' => $price_result['base_price'],
        'DS_PriceForm' => $price_result['design_price'],
        'Order_PriceForm' => $total_price_with_options,
        'VAT_PriceForm' => ($total_price_with_options * 0.1),
        'Total_PriceForm' => $total_with_vat_with_options,
        'StyleForm' => $MY_type,
        'SectionForm' => $Section,
