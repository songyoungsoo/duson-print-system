...
<div class="nav-menu">
    <div class="nav-content">
        <div class="nav-links">
            <a href="/MlangPrintAuto/inserted/index.php" class="nav-link <?php echo ($current_page == 'inserted') ? 'active' : ''; ?>">📄 전단지</a>
            <a href="/shop/view_modern.php" class="nav-link <?php echo ($current_page == 'sticker') ? 'active' : ''; ?>">🏷️ 스티커</a>
            <a href="/MlangPrintAuto/cadarok/index.php" class="nav-link <?php echo ($current_page == 'cadarok') ? 'active' : ''; ?>">📖 카다록</a>
