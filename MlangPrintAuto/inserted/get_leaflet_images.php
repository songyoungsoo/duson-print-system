<?php
/**
 * 전단지 포트폴리오 이미지 API - ImgFolder 갤러리 통합 버전
    ...
    if (empty($images)) {
        ...
        for ($i = 1; $i <= 4; $i++) {
            $images[] = [
                ...
                'path' => '/images/samples/inserted_sample_' . $i . '.jpg',
                'image_path' => '/images/samples/inserted_sample_' . $i . '.jpg',
                'thumbnail' => '/images/samples/inserted_sample_' . $i . '.jpg',
                'thumbnail_path' => '/images/samples/inserted_sample_' . $i . '.jpg',
                'thumb_path' => '/images/samples/inserted_sample_' . $i . '.jpg',
                'url' => '/images/samples/inserted_sample_' . $i . '.jpg',
                'thumb' => '/images/samples/inserted_sample_' . $i . '.jpg',
                'category' => '전단지',
                'is_default' => true
            ];
        }
