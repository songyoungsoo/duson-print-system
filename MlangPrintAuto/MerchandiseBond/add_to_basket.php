...
// 디버그: 받은 데이터 로그
error_log("상품권 장바구니 추가 - 받은 데이터: " . print_r($_POST, true));
...
$upload_directory = "../../ImgFolder/{$img_folder}/";
...
if ($stmt) {
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        // ImgFolder는 기존 시스템과 동일한 형식 사용
        $img_folder_path = $img_folder; // {log_url}/{log_y}/{log_md}/{log_ip}/{log_time} 형식
