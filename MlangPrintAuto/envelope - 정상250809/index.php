...
// 페이지 제목 설정
$page_title = generate_page_title("봉투 자동견적");
?>
...
<body>
    ...
    <div class="main-content-wrapper">
        <div class="page-header">
            <h1>✉️ 봉투 자동견적</h1>
            <p>다양한 종류의 봉투 견적을 쉽고 빠르게 확인하세요</p>
        </div>
        ...
        <form id="envelopeForm" method="post">
            <div class="form-container">
                ...
                <div class="info-panel">
                    <h3>ℹ️ 봉투 안내</h3>
                    <div class="info-text">
                        <p><strong>봉투 특징:</strong></p>
                        <ul>
                            <li>다양한 규격 및 재질의 봉투 제작</li>
                            <li>자켓형, 일반형 등 다양한 형태</li>
                            <li>회사 로고, 주소 등 인쇄 가능</li>
                            <li>최소 1000매부터 주문 가능</li>
                        </ul>
            ...
            <div id="priceSection" class="price-section">
                ...
                <div class="selected-options">
                    ...
                    <div class="option-item">
                        <div class="option-label">인쇄색상</div>
                        <div class="option-value" id="selectedColor">-</div>
                    </div>
                    <div class="option-item">
