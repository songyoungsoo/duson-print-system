...
// 장바구니에 추가
$insert_query = "INSERT INTO shop_temp (session_id, product_type, MY_type, MY_amount, POtype, PN_type, ordertype, st_price, st_price_vat) 
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";

$stmt = mysqli_prepare($db, $insert_query);
if ($stmt) {
    mysqli_stmt_bind_param($stmt, "sssssssii", $session_id, $product_type, $MY_type, $MY_amount, $POtype, $PN_type, $ordertype, $price, $vat_price);
