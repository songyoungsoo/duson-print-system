...
// 디버그: 받은 데이터 로그
error_log("명함 장바구니 추가 - 받은 데이터: " . print_r($_POST, true));
...
if ($stmt) {
    mysqli_stmt_bind_param($stmt, "sssssssii", $session_id, $product_type, $MY_type, $Section, $POtype, $MY_amount, $ordertype, $price, $vat_price);
