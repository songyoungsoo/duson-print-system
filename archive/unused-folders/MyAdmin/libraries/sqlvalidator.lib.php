 ...
 * <http://developer.mimer.com/validator/index.php> from phpMyAdmin
 *
...
if (!defined('PMA_SQL_VALIDATOR_INCLUDED')) {
     ...
     *
     * <http://developer.mimer.com/validator/index.php>
     *
    ...
    function PMA_validateSQL($sql)
    {
        ...
        if ($cfg['SQLValidator']['use']) {
            if (!(isset($GLOBALS['sqlvalidator_error'])
                ...
                $str = sprintf($GLOBALS['strValidatorError'], '<a href="./Documentation.php#faqsqlvalidator" target="documentation">', '</a>');
