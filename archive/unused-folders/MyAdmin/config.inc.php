 ...
 *
 * All directives are explained in Documentation.php
 */
 ...
 */
$cfg['PmaAbsoluteUri'] = 'http://dsp114.com/MyAdmin/';
...
$cfg['Servers'][$i]['user']          = 'duson1830';      // MySQL user
$cfg['Servers'][$i]['password']      = 'du1830';          // MySQL password (only needed
                                                    // with 'config' auth_type)
$cfg['Servers'][$i]['only_db']       = 'duson1830';          // If set to a db-name, only
 ...
 * See http://www.mysql.com/documentation/index.php for more information
