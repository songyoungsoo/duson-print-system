...
function PMA_myHandler($sql_insert = '')
{
    ...
    $sql_insert = preg_replace('INSERT INTO (`?)' . $table . '(`?)', 'INSERT INTO ' . $target, $sql_insert);
...
//    $sql_structure = preg_replace('^CREATE TABLE (`?)' . $table . '(`?)', 'CREATE TABLE ' . $target, $sql_structure);
