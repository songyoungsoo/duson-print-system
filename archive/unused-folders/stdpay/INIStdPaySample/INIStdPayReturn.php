...
<?php
        ...
        try {
            ...
            if (strcmp("0000", $_REQUEST["resultCode"]) == 0) {
                ...
                $mid 				= $_REQUEST["dsp1147479"];     						// 가맹점 ID 수신 받은 데이터로 설정

                $signKey 			= "cEdnbCtISFZ1QUNpNm5hbG1JY1RlQT09";   //cEdnbCtISFZ1QUNpNm5hbG1JY1RlQT09			// 가맹점에 제공된 키(이니라이트키) (가맹점 수정후 고정) !!!절대!! 전문 데이터로 설정금지

                $timestamp 			= $util->getTimestamp();   						// util에 의해서 자동생성

                $charset 			= "UTF-8";        								// 리턴형식[UTF-8,UTF-8](가맹점 수정후 고정)
