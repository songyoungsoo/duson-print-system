...
// MySQLi 데이터베이스 연결 (mysql_* 함수는 더 이상 사용되지 않으므로 mysqli_*로 변경)
$connect = mysqli_connect('localhost', 'duson1830', 'du1830', 'duson1830');
if (!$connect) {
    die("MySQL 서버 연결 오류: " . mysqli_connect_error());
}

$no = $_POST['no']; // $no 변수 정의

// 조회 쿼리 실행 (SQL Injection 방지용 prepared statement 권장)
$query = "SELECT * FROM MlangOrder_PrintAuto WHERE no=?";
$stmt = mysqli_prepare($connect, $query);
if (!$stmt) {
    die("쿼리 준비 오류: " . mysqli_error($connect));
}
...
$mid = "dsp1147479";  // 가맹점 ID(가맹점 수정후 고정)					
//인증
$signKey = "cEdnbCtISFZ1QUNpNm5hbG1JY1RlQT09"; // 가맹점에 제공된 키(signkey) (가맹점 수정후 고정) !!!절대!! 전문 데이터로 설정금지
$timestamp = $SignatureUtil->getTimestamp();   // util에 의해서 자동생성
$orderNumber = $mid . "_" . $timestamp; // 가맹점 주문번호(가맹점에서 직접 설정)
$price = "$data[money_5]";        // 상품가격(특수기호 제외, 가맹점에서 직접 설정)
...
/* 기타 */
$siteDomain = "http://dsp114.com/stdpay/INIStdPaySample"; //가맹점 도메인 입력
...
<html>
    ...
    <!--
      ...
      4) 가맹점에서 사용하는 케릭터셋이 UTF-8 일 경우 charset="UTF-8"로 UTF-8 일 경우 charset="UTF-8"로 설정합니다.
    -->	
...
<!-- onload="paybtn()" -->
    ...
    <body onload="paybtn()" bgcolor="#FFFFFF" text="#242424" leftmargin=0 topmargin=15 marginwidth=0 marginheight=0 bottommargin=0 rightmargin=0>
...
<!-- 
                        ...
                        <tr>
    <td>
        <button onclick="paybtn()" style="padding: 10px; height: 50px; width: 120px; background-color: #FFC100; border-radius: 5px; border-color: #cccccc;">결제요청</button>&nbsp;&nbsp;
        <button onclick="goBack()" style="padding: 10px; height: 50px; width: 120px; background-color: #FFC100; border-radius: 5px; border-color: #cccccc;">이전 페이지</button>
    </td>
                        ...
                        <tr>
                            <td>
                                    ...
                                    <tr>
                                        <td style="text-align:left;">
                                            <form id="SendPayForm_id" name="" method="POST" >
                                                ...
                                                <div style="border:2px #dddddd double;padding:10px;background-color:#f3f3f3;width:570px;">

                                                    <br/><b>version</b> :
                                                    <br/><input type="hidden"  style="width:570px;" name="version" value="1.0" >

                                                    <br/><b>mid</b> :
                                                    <br/><input  style="width:570px;" name="mid" value="<?php echo $mid ?>" >

                                                    <br/><b>goodname</b> :
                                                    <br/><input  style="width:570px;" name="goodname" value="<?php echo iconv('UTF-8','UTF-8',$data['Type_1']) ?>" >

                                                    <br/><b>oid</b> :
                                                    <br/><input   style="width:570px;" name="oid" value="<?php echo $orderNumber ?>" >

                                                    <br/><b>price</b> :
                                                    <br/><input   style="width:570px;" name="price" value="<?php echo $price ?>" >

                                                    <br/><b>currency</b> :
                                                    <br/>[WON]
                                                    <br/><input type="hidden"  style="width:570px;" name="currency" value="WON" >

                                                    <br/><b>buyername</b> :
                                                    <br/><input   style="width:570px;" name="buyername" value="<?php echo iconv('UTF-8','UTF-8',$data['name']) ?>" >

                                                    <br/><b>buyertel</b> :
                                                    <br/><input  style="width:570px;" name="buyertel" value="<?php echo $data['phone'] ?>">

                                                    <br/><b>buyeremail</b> :
                                                    <br/><input  style="width:570px;" name="buyeremail" value="<?php echo $data['email'] ?>" >
                                                    
                                                    <!-- <br/><b>timestamp</b> : -->
                                                    <input type="hidden" style="width:570px;" name="timestamp" value="<?php echo $timestamp ?>" >


                                                    <!-- <br/><b>signature</b> : -->
                                                    <input type="hidden" style="width:570px;" name="signature" value="<?php echo $sign ?>" >


                                                    <br/><b>returnUrl</b> :
                                                    <!-- <br/><input type="hidden"  style="width:570px;" name="returnUrl" value="<?php echo $siteDomain ?>/INIStdPayReturn.php" > 결제후 돌아가는페이지-->
                                                    <br/><input type="hidden"  style="width:570px;" name="returnUrl" value="<?php echo $siteDomain ?>/INIStdPayReturn.php" >
                                ...
                                <div style="display:none;">
                                                <br/><br/>
                                                <b>***** 기본 옵션 *****</b>
                                                 <div style="border:1px #dddddd double;padding:10px;background-color:#f3f3f3;">
                                                    ...
                                                    <br/><input type="hidden"  style="width:100%;" name="offerPeriod" value="2015010120150331" >
                                                    <br/><br/>
                                                ...
                                                <div style="border:1px #dddddd double;padding:10px;background-color:#f3f3f3;">
                                                    ...
                                                    <br/>[ko|en] (default:ko) -->
                                                    <br/><input type="hidden" style="width:100%;" name="languageView" value="" >

                                                    <br/><b>charset</b> : 리턴 인코딩
                                                    <br/>[UTF-8|UTF-8] (default:UTF-8)
                                                    <br/><input type="hidden" style="width:100%;" name="charset" value="" >

                                                    <br/><b>payViewType</b> : 결제창 표시방법
                                                    <br/>[overlay] (default:overlay)
                                                    <br/><input type="hidden" style="width:100%;" name="payViewType" value="popup" >
                                                    ...
                                                    <br/><input type="hidden" style="width:100%;" name="closeUrl" value="<?php echo $siteDomain ?>/close.php" >
                                                    ...
                                                    <br/><input type="hidden" style="width:100%;" name="popupUrl" value="<?php echo $siteDomain ?>/popup.php" >
                                                ...
                                                <div style="border:2px #cccccc solid;padding:10px;background-color:#f3f3f3;">
                                                    ...
                                                    <br/><input type="hidden"  style="width:100%;" name="nointerest" value="<?php echo $cardNoInterestQuota ?>" >

                                                    <br/><b>quotabase</b> : 할부 개월
                                                    <br/>ex) 2:3:4
                                                    <br/><input type="hidden"  style="width:100%;" name="quotabase" value="<?php echo $cardQuotaBase ?>" >	
                                                ...
                                                <div style="border:2px #cccccc solid;padding:10px;background-color:#f3f3f3;">
                                                    ...
                                                    <br/><input type="hidden"  style="width:100%;" name="INIregno" value="" >
                                                </div>
