            ...
            <table>
                ...
                <tbody>
                    ...
                    <?php if ($quotation['delivery_price'] > 0):
                        $delivery_vat = $quotation['delivery_vat'] ?? round($quotation['delivery_price'] * 0.1);
                        $delivery_total = $quotation['delivery_price'] + $delivery_vat;
                    ?>
                    <tr>
                        <td><?php echo $no++; ?></td>
                        <td>배송비 (<?php echo htmlspecialchars($quotation['delivery_type'] ?? '택배'); ?>)</td>
                        <td>1</td>
                        <td style="text-align:right;"><?php echo number_format($quotation['delivery_price']); ?>원 (공급가)</td>
                    </tr>
                    <tr>
                        <td></td>
                        <td style="padding-left:20px;color:#666;">└ 배송비 VAT</td>
                        <td></td>
                        <td style="text-align:right;color:#666;"><?php echo number_format($delivery_vat); ?>원</td>
                    </tr>
                    <?php endif; ?>
                </tbody>
                <tfoot>
