...
<body>
  ...
  <section class="relative overflow-hidden">
    <div id="hero-slider" class="relative" style="height: 520px;">
      <!-- Slider Content -->
      <div class="slider-container relative w-full h-full">
        ...
        <div class="slider-slide absolute inset-0 opacity-100 transition-opacity duration-1000" data-slide="0">
          <img src="/slide/slide_inserted.gif?refresh=<?=microtime(true).rand(10000,99999)?>" alt="전단지 인쇄 서비스" class="w-full h-full object-cover" loading="lazy">
        </div>
        
        <!-- Slide 2: 스티커 -->
        <div class="slider-slide absolute inset-0 opacity-0 transition-opacity duration-1000" data-slide="1">
          <img src="/slide/slide__Sticker.gif?refresh=<?=microtime(true).rand(10000,99999)?>" alt="스티커 인쇄 서비스" class="w-full h-full object-cover" loading="lazy">
        </div>
        
        <!-- Slide 3: 카다록 -->
        <div class="slider-slide absolute inset-0 opacity-0 transition-opacity duration-1000" data-slide="2">
          <img src="/slide/slide_cadarok.gif?refresh=<?=microtime(true).rand(10000,99999)?>" alt="카다록 인쇄 서비스" class="w-full h-full object-cover" loading="lazy">
        </div>
        
        <!-- Slide 4: NCR 양식지 -->
        <div class="slider-slide absolute inset-0 opacity-0 transition-opacity duration-1000" data-slide="3">
          <img src="/slide/slide_Ncr.gif?refresh=<?=microtime(true).rand(10000,99999)?>" alt="NCR 양식지 인쇄 서비스" class="w-full h-full object-cover" loading="lazy">
        </div>
        
        <!-- Slide 5: 포스터 -->
        <div class="slider-slide absolute inset-0 opacity-0 transition-opacity duration-1000" data-slide="4">
          <img src="/slide/slide__poster.gif?refresh=<?=microtime(true).rand(10000,99999)?>" alt="포스터 인쇄 서비스" class="w-full h-full object-cover" loading="lazy">
        </div>
        
        <!-- Slide 6: 스티커 2 -->
        <div class="slider-slide absolute inset-0 opacity-0 transition-opacity duration-1000" data-slide="5">
          <img src="/slide/slide__Sticker_2.gif?refresh=<?=microtime(true).rand(10000,99999)?>" alt="스티커 제작 서비스 2" class="w-full h-full object-cover" loading="lazy">
        </div>
        
        <!-- Slide 7: 스티커 3 -->
        <div class="slider-slide absolute inset-0 opacity-0 transition-opacity duration-1000" data-slide="6">
          <img src="/slide/slide__Sticker_3.gif?refresh=<?=microtime(true).rand(10000,99999)?>" alt="스티커 제작 서비스 3" class="w-full h-full object-cover" loading="lazy">
        </div>
      </div>
      ...
      <!-- Navigation Arrows -->
      <button class="slider-prev absolute left-4 top-1/2 transform -translate-y-1/2 w-12 h-12 bg-white/20 hover:bg-white/30 rounded-full flex items-center justify-center text-white text-xl transition" aria-label="이전 슬라이드">
        ‹
      </button>
      <button class="slider-next absolute right-4 top-1/2 transform -translate-y-1/2 w-12 h-12 bg-white/20 hover:bg-white/30 rounded-full flex items-center justify-center text-white text-xl transition" aria-label="다음 슬라이드">
        ›
      </button>
    </div>
  </section>
