...
// 통합 갤러리 시스템 초기화 - 제거됨 (새 갤러리 v2.0 사용)
...
<head>
    ...
    <!-- 🆕 Duson 통합 갤러리 시스템 CSS - 제거됨 (새 갤러리 v2.0 사용) -->
    ...
    <?php
    // 갤러리 에셋 자동 포함 - 제거됨 (새 갤러리 v2.0 사용)
...
<body class="namecard-page">
    ...
    <!-- 통합 갤러리 모달 - 제거됨 (새 갤러리 v2.0에서 자체 모달 포함) -->
    ...
    <?php
    // 갤러리 모달과 JavaScript - 제거됨 (새 갤러리 v2.0에서 자체 처리)
    ?>
