...
<body>
    <div class="quote-paper">
        ...
        <table style="margin-bottom: 8px;">
            ...
            <tr>
                <td style="font-weight: bold; background: #f0f0f0;">고객명</td>
        ...
        <table class="items-table">
            <thead>
                <tr>
                    ...
                    <th style="width: 15%;">공급가액(VAT별도)</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="center"><?php echo number_format($item['quantity']); ?></td>
                    <td class="center"><?php echo htmlspecialchars($item['unit']); ?></td>
                    <td class="right"><?php echo number_format($item['unit_price']); ?></td>
        ...
        <div class="footer-info">
            ...
            <p><strong>고객명 :</strong> <?php echo htmlspecialchars($quote['customer_name']); ?></p>
        ...
        <div class="actions">
            ...
            <button class="btn btn-reject" onclick="showResponseForm('reject')">✕ 거절하기</button>
    ...
    function showResponseForm(action) {
        ...
        document.getElementById('responseTitle').textContent = action === 'accept' ? '견적서를 승인하시겠습니까?' : '견적서를 거절하시겠습니까?';
