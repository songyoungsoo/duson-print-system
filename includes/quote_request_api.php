...
<div style="max-width:640px;margin:0 auto;font-family:\'Pretendard\',\'Noto Sans KR\',\'Malgun Gothic\',sans-serif;">
  ...
  <div style="background:#fff;border-left:1px solid #2a6496;border-right:1px solid #2a6496;padding:24px;">
    ...
    <div style="text-align:center;margin-top:24px;">
      <a href="' . SITE_URL . '/mlangprintauto/' . htmlspecialchars($productType) . '/" style="display:inline-block;background:#1E4E79;color:#fff;padding:12px 36px;text-decoration:none;font-weight:600;font-size:14px;letter-spacing:1px;">주문하러 가기 →</a>
    </div>
  </div>
  <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
