...
> **⚠️ 레거시 (2026-02-27)**: 이 시스템은 듀얼 채팅 위젯으로 대체되었습니다.
> - 현재 시스템: `chat/chat.js` (ChatWidget 클래스, mode='ai') → **@./chat-system.md**
> - `ai_chatbot_widget.php`는 어디서도 include하지 않음 (사문 파일)
> - 아래 내용은 기존 구현 참조용으로 보존합니다.

### 시스템 개요

영업시간(09:00~18:30) 외 시간에 자동으로 표시되었던 AI 챗봇 위젯.
