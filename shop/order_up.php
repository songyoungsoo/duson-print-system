...
newWindow = window.open("<?php echo $MultyUploadDir?>/"+myurl+"&Mode=tt", "Add_from_Src_to_Dest", props);
}
...
window.open('<?php echo $MultyUploadDir?>/FileDelete.php?FileDelete=ok&Turi=<?php echo $log_url?>&Ty=<?php echo $log_y?>&Tmd=<?php echo $log_md?>&Tip=<?php echo $log_ip?>&Ttime=<?php echo $log_time?>&FileName='+sourceList.options[i].text,'','scrollbars=no,resizable=no,width=100,height=100,top=2000,left=2000');
...
window.open("<?php echo $MultyUploadDir?>/FileDelete.php?DirDelete=ok&Turi=<?php echo $log_url?>&Ty=<?php echo $log_y?>&Tmd=<?php echo $log_md?>&Tip=<?php echo $log_ip?>&Ttime=<?php echo $log_time?>","MlangWinExitsdf","width=100,height=100,top=2000,left=2000,toolbar=no,location=no,directories=no,status=yes,menubar=no,status=yes,menubar=no,scrollbars=no,resizable=yes");
}
}
...
<INPUT TYPE="hidden" name='Turi' value='<?php echo $log_url?>'>
<INPUT TYPE="hidden" name='Ty' value='<?php echo $log_y?>'>
<INPUT TYPE="hidden" name='Tmd' value='<?php echo $log_md?>'>
<INPUT TYPE="hidden" name='Tip' value='<?php echo $log_ip?>'>
<INPUT TYPE="hidden" name='Ttime' value='<?php echo $log_time?>'>
<input type="hidden" name="ImgFolder" value="<?php echo $log_url?>/<?php echo $log_y?>/<?php echo $log_md?>/<?php echo $log_ip?>/<?php echo $log_time?>">   

										<input type='hidden' name=OrderSytle value='<?php echo $View_TtableC?>'>   
  ...
  ※ 입금자명이 다르면 전화요망<tr> 
    ...
    2M이상의 큰파일은 웹하드나 메일을 이용해주세요
       ...
       <tr>
		 ...
		 <td width=30%>
<input type='button' onClick="javascript:small_window('FileUp.php?Turi=<?php echo $log_url?>&Ty=<?php echo $log_y?>&Tmd=<?php echo $log_md?>&Tip=<?php echo $log_ip?>&Ttime=<?php echo $log_time?>');" value=' 파일올리기 ' style="width:80; height:25;"><BR>
