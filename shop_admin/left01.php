...
<div class="menu-container">
    <div class="menu-section">
        ...
        <ul class="menu-list">
            <li><a href="http://dsp114.com/admin/MlangPrintAuto/OrderList.php" target="main">자동주문접수</a></li>
    ...
    <div class="menu-section">
        ...
        <ul class="menu-list">
            <li><a href="http://dsp114.com/MlangPrintAuto/inserted/index.php" target="main">전단지</a></li>
            <li><a href="http://dsp114.com/shop/view.php" target="main">스티커</a></li>
            <li><a href="http://dsp114.com/MlangPrintAuto/sticker/index.php" target="main">종이자석</a></li>
        </ul>
    </div>
    ...
    <div class="menu-section">
        ...
        <ul class="menu-list">
            <li><a href="http://dsp114.com/admin/MlangPrintAuto/admin.php?mode=AdminMlangOrdert" target="main">파일올리기</a></li>
            <li><a href="http://www.dsp114.com/sub/checkboard.htm" target="main">교정보기</a></li>
