...
if (!empty($order_list) && !empty($email)) {
    try {
        ...
        // 입금계좌 정보 (추가)
        $mail_content .= "<div style='background: #fff3cd; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #ffc107;'>";
        $mail_content .= "<h3 style='color: #856404; margin-bottom: 15px;'>💳 입금계좌 안내</h3>";
        $mail_content .= "<p style='margin: 8px 0;'><strong>국민은행:</strong> 999-1688-2384 (예금주: 차경선 두손기획인쇄)</p>";
        $mail_content .= "<p style='margin: 8px 0;'><strong>신한은행:</strong> 110-342-543507 (예금주: 차경선 두손기획인쇄)</p>";
        $mail_content .= "<p style='margin: 8px 0;'><strong>농협:</strong> 301-2632-1830-11 (예금주: 차경선 두손기획인쇄)</p>";
        $mail_content .= "<p style='margin-top: 15px; font-size: 0.9em; color: #856404;'>※ 입금 확인 후 제작이 시작됩니다.</p>";
        $mail_content .= "</div>";
        ...
        $mail_content .= "<p>📞 대표전화: 1688-2384, 02-2632-1830</p>";
        $mail_content .= "<p>🏢 서울 영등포구 영등포로36길 9, 송호빌딩 1층</p>";
