...
전단지는 규격 × 연수로 고정 룩업 (post_list52, delivery_manager 공통):

| 규격 | 박스/연 | 택배비/연 | 비고 |
|------|--------|----------|------|
| A6/B6 | 1 | 4,000원 | |
| A5 | 1 | 6,000원 | |
| A4 | 1 | 6,000원 | 90g 4000매 23kg, 로젠 특약 |
...
*Last Updated: 2026-02-23 (봉투 택배비 자동계산: 펼침면 크기×gsm 기반 무게 계산, 20kg 초과 시 박스 분리, 대봉투 로젠특약 3500원/box, 소봉투/자켓 무게별 차등요금, 전단지 규격별 택배비 룩업 추가, 부자재 무게 제외 확정)*
