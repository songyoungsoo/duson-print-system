...
<form name="EditInfo" method="post" onsubmit="return EditCheckField()" target="POPWIN" action="./editor/submit_ok.php">
    ...
    <tr>
        ...
        <td>
            ...
            <input type="radio" onclick="window.location.href='<?php echo "$PHP_SELF?mode=$mode&code=html&no=$no"; ?>';" name="style" value="html" <?php if($code == "html" || $TT_style == "html") { echo "checked"; } ?>>HTML 직접입력
    ...
    <tr>
        <td colspan="2" align="center">
            ...
            if ($TT_style == "html" || $TT_style == "edit") {
                echo $TT_connent;
            }
            ?></textarea>
        </td>
