...
$query ="UPDATE MlangOrder_PrintAuto SET Type_1='$TypeOne', name='$name', email='$email', zip='$zip', zip1='$zip1', zip2='$zip2', phone='$phone', Hendphone='$Hendphone', bizname='$bizname', bank='$bank', bankname='$bankname', cont='$cont',Gensu='$Gensu' WHERE no='$no'";
...
<td>
<input type="radio" name="MlangFriendSiteInfo" onClick='MlangFriendSiteInfocheck()'>���ùڽ�
<input type="radio" name="MlangFriendSiteInfo" onClick='MlangFriendSiteInfocheck()'>�����Է�
<BR>
