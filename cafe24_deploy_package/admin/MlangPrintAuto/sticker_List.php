...
function WomanMember_Admin_Del(no){
	if (confirm(+no+'번 자료을 삭제 처리 하시겠습니까..?\n\n한번 삭제한 자료는 복구 되지 않으니 신중을 기해주세요.............!!')) {
        ...
        popup = window.open(str, "deletePopup_"+no, "scrollbars=no,resizable=yes,width=400,height=50,top=200,left=200");
        popup.focus();
	}
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
<td align=center><font color=white><?php echo $row['quantity']?>매 (장)</font></td>
<td align=center><font color=white>
