...
<font color=red>*</font> �ڷ� �Է�/���� �� <b><u>YES</u></b>�� �����ϸ� ���� ���������� ȣ�� �˴ϴ�.
</td>
</tr>
<tr>
<td>
...
<input type='button' onClick="javascript:popup=window.open('./<?php echo $PageCode?>/CateAdmin.php?mode=form', 'WebOffice_<?php echo $PageCode?>Form','width=500,height=120,top=0,left=0,menubar=no,resizable=no,statusbar=no,scrollbars=yes,toolbar=no'); popup.focus();" value=' ���� �Է��ϱ� '>
</td>
</tr>
</table>
...
<td align=center><font color=white><?php echo $row[BigNo]?></font></td>
<td>&nbsp;&nbsp;<font color=white><?php echo $row[title]?></font>&nbsp;&nbsp;</td>
<td align=center><font color=white>
<?php if ($row[newy]=="no"){echo("NO");}else{echo("<font style='color:#66CCFF; font:bold;'>YES</font>");}?>
</font></td>
<td align=center>
<input type='button' onClick="javascript:popup=window.open('./<?php echo $PageCode?>/CateAdmin.php?mode=form&code=modify&no=<?php echo $row[no]?>', 'WebOffice_<?php echo $PageCode?>Modify','width=500,height=120,top=0,left=0,menubar=no,resizable=no,statusbar=no,scrollbars=yes,toolbar=no'); popup.focus();" value=' ���� '>
