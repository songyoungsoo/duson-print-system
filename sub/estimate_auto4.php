...
<script language="JavaScript" src="./javascript4.js"></script>
<script language="JavaScript" src="./selScript4.js"></script>
<style type="text/css">
...
<form action="estimate_auto_PC.php" method="post" name="ordform" id="ordform" enctype="multipart/form-data" onSubmit="return  formChk()">
      <table width="692" border="0" cellpadding="0" cellspacing="1" bgcolor="#D7D7D7">
        ...
        <tr> 
          ...
          <td width="567" bgcolor="#FFFFFF"> &nbsp; <input name="kind" type="radio" value="1"  onClick="location.href='?pg=1'">
            ...
            전단 
            <input name="kind" type="radio" value="4" checked>
        <b>서식지</b> 
      ...
      <table width="692" border="0" cellpadding="0" cellspacing="1" bgcolor="#D7D7D7">
        <tr> 
          ...
          <option value="1">서식지 - 48절 빌지(간이영수증)</option>
          <option value="2">서식지 - 32절(거래명세표)</option>
          <option value="3">서식지 - A5</option>
          <option value="4">서식지 - A4</option>
          <option value="5">서식지 - 16절</option>
          <option value="6">NCR지(상하지) - 48절 빌지(간이영수증)</option>
		  <option value="7">NCR지(상하지)  - 32절(거래명세표)</option>
          <option value="8">NCR지(상하지)  - A5</option>
          <option value="9">NCR지(상하지)  - A4</option>
          <option value="10">NCR지(상하지)  - 16절</option>
 	      <option value="11">NCR지(상중하지) - 48절 빌지(간이영수증)</option>
          <option value="12">NCR지(상중하지) - 32절(거래명세표)</option>
          <option value="13">NCR지(상중하지) - A5</option>
          <option value="14">NCR지(상중하지) - A4</option>
          <option value="15">NCR지(상중하지) - 16절</option>
        </select> </td>
        </tr>
        <tr> 
