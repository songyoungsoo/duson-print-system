...
<table border=0 align=center width=100% cellpadding='8' cellspacing='3' background='/img/sian_top_line_back.jpg'>
  <tr>
    <td align=left>
      ...
      <table border=0 cellpadding=2 cellspacing=0 width=100%>
        <tr>
          <form method='post' name='TDsearch' onsubmit='javascript:return TDsearchCheckField()' action='<?= $_SERVER["PHP_SELF"] ?>'>
            <td align=left>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <b>주문자명 or 업종별:</b><input type='hidden' name='TDsearch' value='name'>
          ...
          <td align=right>
            ...
            <select onchange="MM_88jumpMenu('parent',this,0)">
...
<table border=0 align=center width=100% cellpadding='0' cellspacing='0' style='word-break:break-all;'>
  <tr>
    ...
    <td align=center background='/img/box/A1_TopBack.gif' width=70 valign=bottom>
      <font style='font:bold; color:#3399FF;'>등록번호</font>
    </td>
    <td align=center background='/img/box/A1_TopBack.gif' width=139 valign=bottom>
      <font style='font:bold; color:#3399FF;'>분류</font>
    </td>
    <td align=center background='/img/box/A1_TopBack.gif' width=200 valign=bottom>
      <font style='font:bold; color:#3399FF;'>주문인성함</font>
    </td>
    <td align=center background='/img/box/A1_TopBack.gif' width=90 valign=bottom>
      <font style='font:bold; color:#3399FF;'>담당자</font>
    </td>
    <td align=center background='/img/box/A1_TopBack.gif' width=100 valign=bottom>
      <font style='font:bold; color:#3399FF;'>주문날짜</font>
    </td>
    <td align=center background='/img/box/A1_TopBack.gif' width=100 valign=bottom>
      <font style='font:bold; color:#3399FF;'>처리</font>
    </td>
    <td align=center background='/img/box/A1_TopBack.gif' width=120 valign=bottom>
      <font style='font:bold; color:#3399FF;'>시안</font>
    </td>
  ...
  ?>
      ...
      <tr bgcolor='#FFFFFF'>
        <td background='/img/box/A1_CenterLeft.gif'></td>
        <td background='/img/box/A1_CenterBack.gif' height=32 align=center>
          <?= $row['no'] ?>
        </td>
        <td background='/img/box/A1_CenterBack.gif' align=center>
          <?php if ($row['Type'] == "inserted") { ?>전단지
          <?php } else if ($row['Type'] == "sticker") { ?>스티카
          <?php } else if ($row['Type'] == "NameCard") { ?>명함
          <?php } else if ($row['Type'] == "MerchandiseBond") { ?>상품권
          <?php } else if ($row['Type'] == "envelope") { ?>봉투
          <?php } else if ($row['Type'] == "NcrFlambeau") { ?>양식지
          <?php } else if ($row['Type'] == "cadarok") { ?>카다로그
          <?php } else if ($row['Type'] == "LittlePrint") { ?>소량인쇄
        <?php } else {
          echo ($row['Type']);
        } ?>
        </td>
        <td background='/img/box/A1_CenterBack.gif' align=center>
          <font style='color:#38409B; font-size:10pt;'><?= htmlspecialchars($row['name']); ?></font>
        </td>
        <td background='/img/box/A1_CenterBack.gif' align=center>
          <font style='color:#38409B; font-size:10pt;'><?= $row['Designer']; ?></font>
        </td>
        <td background='/img/box/A1_CenterBack.gif' align=center>
        ...
        <td background='/img/box/A1_CenterBack.gif' align=center>
          <a href='#' onClick="javascript:popup=window.open('/MlangOrder_PrintAuto/WindowSian.php?mode=OrderView&no=<?= $row['no'] ?>', 'MViertWasd','width=900,height=400,top=0,left=0,menubar=no,resizable=yes,statusbar=no,scrollbars=yes,toolbar=no'); popup.focus();"><img src='/img/button/sian.gif' border=0 align='absmiddle'></a>
        </td>
        <td background='/img/box/A1_CenterRight.gif'></td>
      </tr>
      ...
      <tr>
        <td background='/img/box/A1_CenterLeft.gif'></td>
        <td height=1 bgcolor='#A4D1FF' background='/img/left_menu_back_134ko.gif' height=1 colspan=7></td>
        <td background='/img/box/A1_CenterRight.gif'></td>
      </tr>
  <?php
    }
