...
<table width="1110" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr> 
	...
	<td valign="top" bgcolor="#FFFFFF"> 
      ...
      // // bbs.php 파일 존재 여부 확인
      // if(file_exists("$BbsDir/bbs.php")) {
      //     include "$BbsDir/bbs.php";
      // } else {
      //     echo "<p style='color:red;'>게시판 파일을 찾을 수 없습니다. ($BbsDir/bbs.php)</p>";
      // }
?>                </td>
              </tr>
            </table></td>
...
width=3></TD>
                  <TD width="99%"><FONT color=#333333>* 편집디자인비 : A2 100,000원, 
                    4절 100,000원, A3 80,000원 <FONT 
                                color=#333333><B>(참고)</B>작업의 성격에 따라 편집디자인비는 변동될 
                      수 있습니다. </FONT></FONT></TD>
                </TR>
                <TR>
                  <TD width="1%" height=15></TD>
                  <TD width="99%" height=15><FONT color=#333333>* 편집디자인비 무료 : 
                    직접 디자인해서 파일 로 보낼 경우(<A 
                ...
                <TR>
                  ...
                  <TD width="99%" height=15><FONT color=#333333>* 제작기간(고객께서 받으시기까지)은 
                    약 2~3 일(후가공 여부에 따라 작업기간은 변경될 수 있습니다)</FONT></TD>
                </TR>
                <TR>
                  <TD height=15></TD>
