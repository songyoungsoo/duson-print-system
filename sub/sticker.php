...
<body background="/img/bg.gif" onLoad="MM_preloadImages('../img/main_m1a.jpg','../img/main_m3a.jpg','../img/main_m5a.jpg','../img/main_m8a.jpg','../img/main_m2a.jpg','../img/main_m10a.jpg','../img/main_m11a.jpg','../img/main_m6a.jpg','../img/main_m7a.jpg','../img/stickerbutton.jpg','../img/stickerdayover.jpg','../img/subjk-01.jpg')">
  ...
  <tr> 
	...
	<td valign="top" bgcolor="#FFFFFF"> 
      ...
      <table width="821" border="0" cellpadding="0" cellspacing="0">
        ...
        <td><a href="sticker.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image25','','../img/main_m7a.jpg',2)"><img src="../img/main_m7.jpg" name="Image25" width="77" height="32" border="0"></a></td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td valign="top"><a href="/shop/view.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('subj-01','','../img/subjk-01.jpg',1)"><img src="../img/subj-01.jpg" alt="스티커가격보기" name="subj-01" width="821" height="60" border="0"></a></td>
        </tr>
        <tr> 
...
?>                </td>
      ...
      <table width="100%" border="0" cellpadding="0">
        <tr>
          <td><p align="left"><img src="images/sticker_material2.jpg" alt="스티커재질 설명" width="821" height="2492" /><br>
          <img src="../img/stickerday.jpg" width="821" height="334" border="0"></a></p></td>
        </tr>
      </table>
      <table width="100%" border="0" cellpadding="5">
        <tr>
          <td><p><a href="http://localhost/shop/view.php"><img src="../img/pbt.jpg" alt="가격보기로이동합니다" width="78" height="78" border="0"></a><a href="/shop/view.php"><img src="../img/obt.jpg" alt="주문하기버튼" width="78" height="78" border="0"></a></p>
