...
// �����ڷḦ ���� ���ε��Ѵ�.
	$upDir = $DOCUMENT_ROOT."/upHand/$kind/";		//������ ���ε��� ���� : �������� ���ε��
	if (!is_dir($upDir)){
		mkdir($upDir,0707);
	}
	chmod("$upDir",0755);
...
//--- DB�� �ڷᰪ�� �Է��Ѵ�.
	$wdate = date("Y-m-d");
	$sql="insert into orderDB2 (`content`,`name`,`company`,`tel`,`fax`,`cell`,`email`,`file1`,`file2`,`file3`,`file4`,`file5`,`ordDate`,`kind`) values('$content','$ordername','$company','$tel','$fax','$cel','$email','$atch1','$atch2','$atch3','$atch4','$atch5','$wdate','$kind')";
//echo $sql; exit;
	$result = mysql_query($sql,$connection); 
