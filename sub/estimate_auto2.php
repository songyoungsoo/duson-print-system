...
<script language="JavaScript" src="./selScript2.js"></script>
<style type="text/css">
...
<form action="estimate_auto_PC.php" method="post" name="ordform" id="ordform" enctype="multipart/form-data" onSubmit="return  formChk()">
      <table width="692" border="0" cellpadding="0" cellspacing="1" bgcolor="#D7D7D7">
        ...
        <tr> 
          ...
          <td width="567" bgcolor="#FFFFFF"> &nbsp; <input name="kind" type="radio" value="1" onClick="location.href='?pg=1'" >
            명함 
            <input type="radio" name="kind" value="2"checked>
        <b>스티커</b> 
      ...
      <table width="692" border="0" cellpadding="0" cellspacing="1" bgcolor="#D7D7D7">
        <tr> 
          ...
          <td width="568" bgcolor="#FFFFFF"> &nbsp; <select name="paper" id="paper" onChange="viewSize(this.form)">
              <option>▒ 용지를 선택해 주세요 ▒</option>
              <option value="1">사각스티커-일반인쇄</option>
              <option value="2">사각스티커-배경인쇄</option>
              <option value="3">원형스티커</option>
              <option value="4">타원형스티커</option>
              <option value="5">CD자켓 스티커</option>
			  <option value="6">CD도무송 스티커</option>
			  <option value="7">종이자석 스티커</option>
			  <option value="8">자석 스티커</option>
            </select> </td>
        </tr>
        <tr><td height="0" colspan=2>
          ...
          <td  bgcolor="#FFFFFF"> &nbsp; <select name="size" id="size" onChange="viewCnt();calc()">
            ...
            </select><input type="hidden" name="sizechk"> </td></tr></table></div>
		</td>
        </tr>     
		<tr> 
      ...
      <td width="568" height="25" bgcolor="#FFFFFF"> &nbsp; 
        <select name="cnt" id="cnt" onChange="calc()">
              <option>▒ 수량 ▒</option>
            </select><input type="hidden" name="cntchk"></td>
        </tr>
