...
<script language="JavaScript" src="./javascript3.js"></script>
<script language="JavaScript" src="./selScript3.js"></script>
<style type="text/css">
...
<form action="estimate_auto_PC.php" method="post" name="ordform" id="ordform" enctype="multipart/form-data" onSubmit="return  formChk()">
      <table width="692" border="0" cellpadding="0" cellspacing="1" bgcolor="#D7D7D7">
        ...
        <tr> 
          ...
          <td width="567" bgcolor="#FFFFFF"> &nbsp; <input name="kind" type="radio" value="1" onClick="location.href='?pg=1'">
            ...
            스티커 
            <input name="kind" type="radio" value="3" checked>
        <b>전단</b> 
      ...
      <table width="692" border="0" cellpadding="0" cellspacing="1" bgcolor="#D7D7D7">
        <tr> 
          ...
          <option selected>▒ 용지를 선택해 주세요 ▒</option>
          <option value="1">A4 / 4,000장</option>
          <option value="2">A5 / 8,000장</option>
          <option value="3">A3 / 2,000장</option>
          <option value="4">A2 / 1,000장</option>
          <option value="5">B5(16절) / 8,000장</option>
          <option value="6">B6(32절) / 16,000장</option>
          <option value="7">B4(8절) / 4,000장</option>
          <option value="8">B3(4절) / 2,000장</option>
          <option value="9">B2(2절) / 1,000장</option>
          <option value="10">윤전인쇄 4절 / 2,000장</option>
          <option value="11">윤전인쇄 8절 / 4,000장</option>
        </select> </td>
        </tr>
        <tr> 
          <td height="0" colspan=2>
		           <!--규격메뉴 숨김 --><div  id="sizeA" style="visibility:visible;"> 
		   <table width=100% border=0 cellpadding="0" cellspacing="0"><tr>
          <td height="25" width="123" bgcolor="#F5F5F5"><div align="center"><font color="#666666">규격</font></div></td>
		  <td width=1 bgcolor="#D7D7D7"></td>
          <td  bgcolor="#FFFFFF"> &nbsp; <select name="size" id="size" onChange="viewCnt();calc()">
		...
		<tr>
			  <td height="25" align="center" bgcolor="#F5F5F5"><font color="#666666"> 
                아트/모조</font></td>
          <td  bgcolor="#FFFFFF"> &nbsp; <select name="coating" id="coating" onChange="viewCnt();calc();">
                  <option>▒ 아트/모조 ▒</option>
                </select>
  ...
  <table width="692" border="0" cellpadding="0" cellspacing="1" bgcolor="#D7D7D7">
    ...
    <tr> 
      <td height="25" bgcolor="#FFFFFF"><div align="left"> <font color="#666666">&nbsp; 
          ...
          A4/16절 단면디자인 : 40,000원</font></div></td>
    </tr>
    <tr> 
      <td height="25" bgcolor="#FFFFFF"><div align="left"> <font color="#666666">&nbsp; 
          <input type="radio" name="design" value="b">
          A4/16절 양면디자인 : 70,000원</font></div></td>
    </tr>
    <tr> 
      <td height="25" bgcolor="#FFFFFF"><div align="left"> <font color="#666666">&nbsp; 
          <input name="design" type="radio" value="c">
          A3/8절 단면디자인 : 70,000원 </font></div></td>
    </tr>
    <tr> 
      <td height="25" bgcolor="#FFFFFF"><font color="#666666"> &nbsp; 
        <input name="design" type="radio" value="d">
        A3/8절 양면디자인 : 110,000원 </font> </td>
    </tr>
    <tr> 
      <td height="25" bgcolor="#FFFFFF"><font color="#666666"> &nbsp; 
        <input name="design" type="radio" value="e">
        A2/4절 단면디자인 : 150,000원 </font></td>
    </tr>
    <tr> 
      <td height="25" bgcolor="#FFFFFF"><font color="#666666"> &nbsp; 
        <input name="design" type="radio" value="f">
        A2/4절 양면디자인 : 200,000원 </font></td>
    </tr>
    <tr>
      <td height="25" bgcolor="#FFFFFF"><font color="#666666"> &nbsp; 
        <input name="design" type="radio" value="g">
        포스터 디자인 : 150,000원 
