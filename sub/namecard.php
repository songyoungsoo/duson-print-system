...
<body background="/img/bg.gif" onLoad="MM_preloadImages('../img/main_m1a.jpg','../img/main_m3a.jpg','../img/main_m5a.jpg','../img/main_m8a.jpg','../img/main_m2a.jpg','../img/main_m10a.jpg','../img/main_m11a.jpg','../img/main_m6a.jpg','../img/main_m7a.jpg','../img/stickerbutton.jpg','../img/stickerdayover.jpg','../img/subjk-07.jpg')">
  ...
  <tr> 
	...
	<td valign="top" bgcolor="#FFFFFF"> 
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td valign="top"><a href="/mlangprintauto/NameCard/index.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('subj-07','','../img/subjk-07.jpg',1)"><img src="../img/subj-07.jpg" alt="명함가격보기" name="subj-07" width="821" height="60" border="0"></a></td>
        </tr>
        <tr> 
              ...
              <TBODY>
                ...
                <TR>
                  <TD height=15 colspan="2"><font 
                                color=#333333><a href="/mlangprintauto/NameCard/index.php"><img src="../img/pbt.jpg" alt="가격보기로이동합니다" width="78" height="78" border="0"><img src="../img/obt.jpg" alt="주문하기버튼" width="78" height="78" border="0"></a></font></TD>
                </TR>
                <TR>
                  <TD height=15 ></TD>
                </TR>
...
width=3></TD>
                  <TD width="99%"><FONT color=#333333>* 편집비 단면 5,000원, 양면 1만원, 
                    로고도안은 기본 1만원 (여러명이 주문을 할 경우에는 1명당 1면에 2,000원씩)</FONT></TD>
                </TR>
                <TR>
                  <TD width="1%"><IMG height=3 src="" 
width=3></TD>
                  <TD width="99%"><FONT color=#333333>* 편집비 무료 : 직접 디자인해서 파일로 
                    보낼 경우(<B><A 
                                href="javascript:go_site(103);"><FONT 
                                color=#ff0000>작업 시 유의사항</FONT></A></B> 꼭 참고하세요)</FONT></TD>
                </TR>
                <TR>
                  <TD width="1%"><IMG height=3 src="" 
width=3></TD>
                ...
                <TR>
                  <TD width="1%"><IMG height=3 src="" 
width=3></TD>
                  <TD width="99%"><FONT color=#333333>* 제작기간(고객께서 받으시기까지)은 약2 
                    - 3일(후가공 여부에 따라 작업기간은 변경될 수 있습니다)</FONT></TD>
                </TR>
                <TR>
                  <TD>&nbsp;</TD>
                  <TD>* 인쇄시 정매에서 약간의 로스분이 나옵니다.</TD>
                </TR>
                <TR>
                  <TD>&nbsp;</TD>
                  <TD><FONT color=#333333>* <B>배송료(택배비), 부가세는 별도</B></FONT></TD>
                </TR>
                <TR>
                  <TD>&nbsp;</TD>
                  <TD><FONT color=#333333><B><span class="style3">※ 이메일이나 웹하드에 자료를 올리시는경우 반드시 본인의 연락처를 남기시길 바랍니다.</span></B></FONT></TD>
                </TR>
                <TR>
                  <TD width="1%"><IMG height=3 src="" 
width=3></TD>
