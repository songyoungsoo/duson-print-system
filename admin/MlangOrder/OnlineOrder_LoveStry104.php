...
include"../../db.php";
$result= mysqli_query($db, "select * from MlangOrder_LoveStry104 where no='$no'");
...
<tr>
<td bgcolor='#65B1B1' width=100 class='td1' align='left'>&nbsp;회사명&nbsp;</td>
<td bgcolor='#FFFFFF'>
<?=$row[fild_1]?>
</td>
</tr>
...
<tr>
<td bgcolor='#65B1B1' class='td1' align='left'>&nbsp;대표자이름&nbsp;</td>
...
<tr>
<td bgcolor='#65B1B1' class='td1' align='left'>&nbsp;사업장주소&nbsp;</td>
<td bgcolor='#FFFFFF' class='td2'>
<?=$row[fild_3]?>
</td>
</tr>
...
<tr>
<td bgcolor='#65B1B1' class='td1' align='left'>&nbsp;담당자이름&nbsp;</td>
<td bgcolor='#FFFFFF' class='td2'>
<?=$row[fild_4]?>
</td>
</tr>
...
<tr>
<td bgcolor='#65B1B1' class='td1' align='left'>&nbsp;담당자이메일&nbsp;</td>
<td bgcolor='#FFFFFF' class='td2'>
<?=$row[fild_5]?>
</td>
</tr>
...
<tr>
<td bgcolor='#65B1B1' class='td1' align='left'>&nbsp;담당자전화번호&nbsp;</td>
<td bgcolor='#FFFFFF' class='td2'>
<?=$row[fild_6]?>
</td>
</tr>
...
<tr>
<td bgcolor='#65B1B1' class='td1' align='left'>&nbsp;내용&nbsp;</td>
<td bgcolor='#FFFFFF' class='td2'>
<?php 
        $CONTENT=$row[fild_7];
...
include"../../db.php";
$result = mysqli_query($db, "DELETE FROM MlangOrder_LoveStry104 WHERE no='$no'");
mysqli_close($db);
...
<td align=center><input type='button' onClick="javascript:popup=window.open('<?=$PHP_SELF?>?mode=view&no=<?=$row[no]?>', 'MlangOrder_LoveStry104','width=600,height=430,top=0,left=0,menubar=no,resizable=no,statusbar=no,scrollbars=yes,toolbar=no'); popup.focus();" value=' 자세한정보보기 '></font></td>
<td align=center>
