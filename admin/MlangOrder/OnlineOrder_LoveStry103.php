...
include"../../db.php";
$result= mysql_query("select * from MlangOrder_LoveStry103 where no='$no'",$db);
...
<tr>
<td bgcolor='#65B1B1' width=100 class='td1' align='left'>&nbsp;�̺�Ʈ ����&nbsp;</td>
<td bgcolor='#FFFFFF'>
<?php echo htmlspecialchars($row[style]);?>
</td>
</tr>
...
<?php echo htmlspecialchars($row[fild_1]);?>
</td>
</tr>
...
<td bgcolor='#65B1B1' class='td1' align='left'>&nbsp;�� ��&nbsp;</td>
<td bgcolor='#FFFFFF' class='td2'>
<?php echo htmlspecialchars($row[fild_2]);?>
</td>
</tr>
...
<td bgcolor='#65B1B1' class='td1' align='left'>&nbsp;�������&nbsp;</td>
<td bgcolor='#FFFFFF' class='td2'>
<?php echo htmlspecialchars($row[fild_3]);?>�<?php echo =htmlspecialchars($row[fild_4]);?>�<?php echo =htmlspecialchars($row[fild_5]);?>��
</td>
</tr>
...
<td bgcolor='#65B1B1' class='td1' align='left'>&nbsp;�� ��&nbsp;</td>
<td bgcolor='#FFFFFF' class='td2'>
<?php echo htmlspecialchars($row[fild_6]);?>
</td>
</tr>
...
<td bgcolor='#65B1B1' class='td1' align='left'>&nbsp;�� ��&nbsp;</td>
<td bgcolor='#FFFFFF' class='td2'>
[<?php echo htmlspecialchars($row[fild_7]);?>]&nbsp;<?php echo htmlspecialchars($row[fild_8]);?>&nbsp;<?php echo htmlspecialchars($row[fild_9]);?>
</td>
</tr>
...
<td bgcolor='#FFFFFF' class='td2'>
<?php echo htmlspecialchars($row[fild_10]);?>
</td>
</tr>
...
<td bgcolor='#65B1B1' class='td1' align='left'>&nbsp;�� ��&nbsp;</td>
<td bgcolor='#FFFFFF' class='td2'>
<?php echo htmlspecialchars($row[fild_11]);?>
</td>
</tr>
...
<td bgcolor='#65B1B1' class='td1' align='left'>&nbsp;�� ��&nbsp;</td>
<td bgcolor='#FFFFFF' class='td2'>
<?php echo htmlspecialchars($row[fild_12]);?> cm
</td>
</tr>

<tr>
<td bgcolor='#65B1B1' class='td1' align='left'>&nbsp;ü ��&nbsp;</td>
<td bgcolor='#FFFFFF' class='td2'>
<?php echo htmlspecialchars($row[fild_13]);?> kg
</td>
</tr>

<tr>
<td bgcolor='#65B1B1' class='td1' align='left'>&nbsp;����ó&nbsp;</td>
<td bgcolor='#FFFFFF' class='td2'>
<?php echo htmlspecialchars($row[fild_14]);?>
</td>
</tr>

<tr>
<td bgcolor='#65B1B1' class='td1' align='left'>&nbsp;�ڵ���&nbsp;</td>
<td bgcolor='#FFFFFF' class='td2'>
<?php echo htmlspecialchars($row[fild_15]);?>
</td>
</tr>
...
include"../../db.php";
$result = mysql_query("DELETE FROM MlangOrder_LoveStry103 WHERE no='$no'");
mysql_close();
...
<td align=center><input type='button' onClick="javascript:popup=window.open('<?php echo $PHP_SELF?>?mode=view&no=<?php echo $row[no]?>', 'MlangOrder_LoveStry103','width=600,height=430,top=0,left=0,menubar=no,resizable=no,statusbar=no,scrollbars=yes,toolbar=no'); popup.focus();" value=' �ڼ����������� '></font></td>
<td align=center>
