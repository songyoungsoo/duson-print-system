...
<td>
      <table border=0 align=center width=100% cellpadding=0 cellspacing=0>
       <tr>
         <td align=left>
		 <font style='font-size:10pt; font:bold;'>작성자:</font>&nbsp;<INPUT TYPE="text" NAME="One_1" size=30 <?php if ($View_One_1){echo("value='$View_One_1'");}?> style='font-size:10pt; font:bold; height:22;'>
		 </td>
		 <td align=right>
		 업체구분:
		 <INPUT TYPE="checkbox" NAME="One_2"  value='1' <?php if ($View_One_2=="1"){echo("checked");}?>>신규업체
		 <INPUT TYPE="checkbox" NAME="One_2"  value='2' <?php if ($View_One_2=="2"){echo("checked");}?>>거래업체
		 <INPUT TYPE="checkbox" NAME="One_2"  value='3' <?php if ($View_One_2=="3"){echo("checked");}?>>하청
		 </td>
       </tr>
     </table>
</td>
...
<td class='coolBar'>
     ...
     <table border=1 align=center width=100% cellpadding=0 cellspacing=0>
       <tr>
         <td align=center width=80>
		      <table border=0 align=center width=100% cellpadding=0 cellspacing=3>
                <tr><td align=center <?php if ($View_Two_1 || $View_Two_2){?>bgcolor='#000000'<?php } ?> height=22><?php if ($View_Two_1 || $View_Two_2){?><font style='color:#FFFFFF; font:bold;'><?}else{?><b><?php } ?>상품권</font></td></tr>
               </table>
		 </td>
		 <td nowrap>
		    <INPUT TYPE="checkbox" NAME="Two_1"  value='1' <?php if ($View_Two_1=="1"){echo("checked");}?>>머니빌지
            <INPUT TYPE="text" NAME="Two_2" size=8 <?php if ($View_Two_2){echo("value='$View_Two_2'");}?>>
			&nbsp;&nbsp;
			디자인:<INPUT TYPE="checkbox" NAME="Two_3"  value='1' <?php if ($View_Two_3=="1"){echo("checked");}?>>유
			<INPUT TYPE="checkbox" NAME="Two_3"  value='2' <?php if ($View_Two_3=="2"){echo("checked");}?>>무
			수량:<INPUT TYPE="text" NAME="Two_4" size=8 <?php if ($View_Two_4){echo("value='$View_Two_4'");}?>>
			건수:<INPUT TYPE="text" NAME="Two_5" size=8 <?php if ($View_Two_5){echo("value='$View_Two_5'");}?>>
		 </td>
		 <td width=90 align=center><INPUT TYPE="text" NAME="Two_47" size=10 <?php if ($View_Two_47){echo("value='$View_Two_47'");}?>>원</td>
       </tr>
	   <tr>
		 <td colspan=2 nowrap>
		 &nbsp;&nbsp;&nbsp;
		 인쇄:<INPUT TYPE="checkbox" NAME="Two_6"  value='1' <?php if ($View_Two_6=="1"){echo("checked");}?>>양
			<INPUT TYPE="checkbox" NAME="Two_6"  value='2' <?php if ($View_Two_6=="2"){echo("checked");}?>>단
			&nbsp;
		 후가공:<INPUT TYPE="checkbox" NAME="Two_7_1"  value='1' <?php if ($View_Two_7_1=="1"){echo("checked");}?>>넘버링
			<INPUT TYPE="checkbox" NAME="Two_7_2"  value='1' <?php if ($View_Two_7_2=="1"){echo("checked");}?>>난수
			<INPUT TYPE="checkbox" NAME="Two_7_3"  value='1' <?php if ($View_Two_7_3=="1"){echo("checked");}?>>스크래치
		 </td>
		 <td align=center><INPUT TYPE="text" NAME="Two_48" size=10 <?php if ($View_Two_48){echo("value='$View_Two_48'");}?>>원</td>
       </tr>
	   <tr>
         <td align=center>
		      <table border=0 align=center width=100% cellpadding=0 cellspacing=3>
                <tr><td align=center <?php if ($View_Two_9 || $View_Two_10){?>bgcolor='#000000'<?php } ?> height=22><?php if ($View_Two_9 || $View_Two_10){?><font style='color:#FFFFFF; font:bold;'><?}else{?><b><?php } ?>포스터</font></td></tr>
               </table>
		 </td>
		 <td nowrap>
		    <INPUT TYPE="checkbox" NAME="Two_9"  value='1' <?php if ($View_Two_9=="1"){echo("checked");}?>>A2
			<INPUT TYPE="checkbox" NAME="Two_9"  value='2' <?php if ($View_Two_9=="2"){echo("checked");}?>>4절
			<INPUT TYPE="checkbox" NAME="Two_9"  value='3' <?php if ($View_Two_9=="3"){echo("checked");}?>>2절
			<INPUT TYPE="text" NAME="Two_10" size=6 <?php if ($View_Two_10){echo("value='$View_Two_10'");}?>>
			&nbsp;
			수량:<INPUT TYPE="text" NAME="Two_11" size=5 <?php if ($View_Two_11){echo("value='$View_Two_11'");}?>>
			&nbsp;
			디자인:<INPUT TYPE="checkbox" NAME="Two_12"  value='1' <?php if ($View_Two_12=="1"){echo("checked");}?>>유
			<INPUT TYPE="checkbox" NAME="Two_12"  value='2' <?php if ($View_Two_12=="2"){echo("checked");}?>>무
			&nbsp;
			기타:<INPUT TYPE="text" NAME="Two_13" size=6 <?php if ($View_Two_13){echo("value='$View_Two_13'");}?>>
		 </td>
		 <td align=center><INPUT TYPE="text" NAME="Two_49" size=10 <?php if ($View_Two_49){echo("value='$View_Two_49'");}?>>원</td>
       </tr>
	   <tr>
         <td align=center width=80>
		      <table border=0 align=center width=100% cellpadding=0 cellspacing=3>
                <tr><td align=center <?php if ($View_Two_14 || $View_Two_15){?>bgcolor='#000000'<?php } ?> height=22><?php if ($View_Two_14 || $View_Two_15){?><font style='color:#FFFFFF; font:bold;'><?}else{?><b><?php } ?>전단,리플렛</font></td></tr>
               </table>
		 </td>
		 <td nowrap>
		    <INPUT TYPE="checkbox" NAME="Two_14"  value='1' <?php if ($View_Two_14=="1"){echo("checked");}?>>A4
			<INPUT TYPE="checkbox" NAME="Two_14"  value='2' <?php if ($View_Two_14=="2"){echo("checked");}?>>16절
			...
			&nbsp;
			수량:<INPUT TYPE="text" NAME="Two_16" size=5 <?php if ($View_Two_16){echo("value='$View_Two_16'");}?>>
			&nbsp;
			디자인:<INPUT TYPE="checkbox" NAME="Two_17"  value='1' <?php if ($View_Two_17=="1"){echo("checked");}?>>유
			<INPUT TYPE="checkbox" NAME="Two_17"  value='2' <?php if ($View_Two_17=="2"){echo("checked");}?>>무
		 </td>
		 <td width=90 align=center><INPUT TYPE="text" NAME="Two_50" size=10 <?php if ($View_Two_50){echo("value='$View_Two_50'");}?>>원</td>
       </tr>
	   <tr>
		 <td colspan=2 nowrap>
		 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		 구분:<INPUT TYPE="checkbox" NAME="Two_18"  value='1' <?php if ($View_Two_18=="1"){echo("checked");}?>>합판
			<INPUT TYPE="checkbox" NAME="Two_18"  value='2' <?php if ($View_Two_18=="2"){echo("checked");}?>>독판
			&nbsp;
		 후가공:
	   ...
	   <tr>
         <td align=center width=80>
		      <table border=0 align=center width=100% cellpadding=0 cellspacing=3>
                <tr><td align=center <?php if ($View_Two_21_1 || $View_Two_21_2 || $View_Two_21_3 || $View_Two_21_4 || $View_Two_22){?>bgcolor='#000000'<?php } ?> height=22><?php if ($View_Two_21_1 || $View_Two_21_2 || $View_Two_21_3 || $View_Two_21_4 || $View_Two_22){?><font style='color:#FFFFFF; font:bold;'><?}else{?><b><?php } ?>명함,쿠폰</font></td></tr>
               </table>
		 </td>
		 <td nowrap>
		    <INPUT TYPE="checkbox" NAME="Two_21_1"  value='1' <?php if ($View_Two_21_1=="1"){echo("checked");}?>>코팅
			<INPUT TYPE="checkbox" NAME="Two_21_2"  value='1' <?php if ($View_Two_21_2=="1"){echo("checked");}?>>무코
			<INPUT TYPE="checkbox" NAME="Two_21_3"  value='1' <?php if ($View_Two_21_3=="1"){echo("checked");}?>>반누
			<INPUT TYPE="checkbox" NAME="Two_21_4"  value='1' <?php if ($View_Two_21_4=="1"){echo("checked");}?>>휘나
			&nbsp;
			수량:<INPUT TYPE="text" NAME="Two_22" size=5 <?php if ($View_Two_22){echo("value='$View_Two_22'");}?>>
			건수:<INPUT TYPE="text" NAME="Two_23" size=5 <?php if ($View_Two_23){echo("value='$View_Two_23'");}?>>
			&nbsp;
			인쇄:<INPUT TYPE="checkbox" NAME="Two_24"  value='1' <?php if ($View_Two_24=="1"){echo("checked");}?>>양
			<INPUT TYPE="checkbox" NAME="Two_24"  value='2' <?php if ($View_Two_24=="2"){echo("checked");}?>>단
		 </td>
		 <td width=90 align=center><INPUT TYPE="text" NAME="Two_51" size=10 <?php if ($View_Two_51){echo("value='$View_Two_51'");}?>>원</td>
       </tr>
	   <tr>
		 <td colspan=2 nowrap>
		 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		 구분:<INPUT TYPE="checkbox" NAME="Two_25"  value='1' <?php if ($View_Two_25=="1"){echo("checked");}?>>합판
			<INPUT TYPE="checkbox" NAME="Two_25"  value='2' <?php if ($View_Two_25=="2"){echo("checked");}?>>독판
			&nbsp;
		 후가공:
	   ...
	   <tr>
         <td align=center width=80>
		      <table border=0 align=center width=100% cellpadding=0 cellspacing=3>
                <tr><td align=center <?php if ($View_Two_28 || $View_Two_29){?>bgcolor='#000000'<?php } ?> height=22><?php if ($View_Two_28 || $View_Two_29){?><font style='color:#FFFFFF; font:bold;'><?}else{?><b><?php } ?>복권,넘버링</font></td></tr>
               </table>
		 </td>
		 <td nowrap>
			...
			&nbsp;
			수량:<INPUT TYPE="text" NAME="Two_30" size=5 <?php if ($View_Two_30){echo("value='$View_Two_30'");}?>>
			&nbsp;
			인쇄:<INPUT TYPE="checkbox" NAME="Two_31"  value='1' <?php if ($View_Two_31=="1"){echo("checked");}?>>양
			<INPUT TYPE="checkbox" NAME="Two_31"  value='2' <?php if ($View_Two_31=="2"){echo("checked");}?>>단
		 </td>
		 <td width=90 align=center><INPUT TYPE="text" NAME="Two_52" size=10 <?php if ($View_Two_52){echo("value='$View_Two_52'");}?>>원</td>
       </tr>
	   <tr>
		 <td colspan=2 nowrap>
		 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		 구분:<INPUT TYPE="checkbox" NAME="Two_32"  value='1' <?php if ($View_Two_32=="1"){echo("checked");}?>>합판
			<INPUT TYPE="checkbox" NAME="Two_32"  value='2' <?php if ($View_Two_32=="2"){echo("checked");}?>>독판
			&nbsp;
		 후가공:<INPUT TYPE="checkbox" NAME="Two_33_1"  value='1' <?php if ($View_Two_33_1=="1"){echo("checked");}?>>넘버링
			<INPUT TYPE="checkbox" NAME="Two_33_2"  value='1' <?php if ($View_Two_33_2=="1"){echo("checked");}?>>난수
			<INPUT TYPE="checkbox" NAME="Two_33_3"  value='1' <?php if ($View_Two_33_3=="1"){echo("checked");}?>>스크래치
			&nbsp;
	   ...
	   <tr>
         <td align=center width=80>
		      <table border=0 align=center width=100% cellpadding=0 cellspacing=3>
                <tr><td align=center <?php if ($View_Two_35 || $View_Two_36){?>bgcolor='#000000'<?php } ?> height=22><?php if ($View_Two_35 || $View_Two_36){?><font style='color:#FFFFFF; font:bold;'><?}else{?><b><?php } ?>카다로그</font></td></tr>
               </table>
		 </td>
		 <td nowrap>
		 	<INPUT TYPE="checkbox" NAME="Two_35"  value='1' <?php if ($View_Two_35=="1"){echo("checked");}?>>부수
			<INPUT TYPE="text" NAME="Two_36" size=8 <?php if ($View_Two_36){echo("value='$View_Two_36'");}?>>&nbsp;&nbsp;
            페이지:<INPUT TYPE="text" NAME="Two_37" size=8 <?php if ($View_Two_37){echo("value='$View_Two_37'");}?>>&nbsp;
			지질:<INPUT TYPE="text" NAME="Two_38" size=8 <?php if ($View_Two_38){echo("value='$View_Two_38'");}?>>&nbsp;
			두께:<INPUT TYPE="text" NAME="Two_39" size=8 <?php if ($View_Two_39){echo("value='$View_Two_39'");}?>>
		 </td>
		 <td width=90 align=center><INPUT TYPE="text" NAME="Two_53" size=10 <?php if ($View_Two_53){echo("value='$View_Two_53'");}?>>원</td>
       </tr>
	   <tr>
		 <td colspan=2 nowrap>
		 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            제본<INPUT TYPE="checkbox" NAME="Two_40"  value='1' <?php if ($View_Two_40=="1"){echo("checked");}?>>중철
	   ...
	   <tr>
         <td align=center width=80>
		      <table border=0 align=center width=100% cellpadding=0 cellspacing=3>
                <tr><td align=center <?php if ($View_Two_42 || $View_Two_43){?>bgcolor='#000000'<?php } ?> height=22><?php if ($View_Two_42 || $View_Two_43){?><font style='color:#FFFFFF; font:bold;'><?}else{?><b><?php } ?>스티카</font></td></tr>
               </table>
		 </td>
		 <td nowrap>
		 &nbsp;수량:<INPUT TYPE="text" NAME="Two_42" size=8 <?php if ($View_Two_42){echo("value='$View_Two_42'");}?>>
		 크기:<INPUT TYPE="text" NAME="Two_43" size=8 <?php if ($View_Two_43){echo("value='$View_Two_43'");}?>>
		 &nbsp;
		 <INPUT TYPE="checkbox" NAME="Two_44"  value='1' <?php if ($View_Two_44=="1"){echo("checked");}?>>코팅
		 <INPUT TYPE="checkbox" NAME="Two_44"  value='2' <?php if ($View_Two_44=="2"){echo("checked");}?>>무코
		 </td>
		 <td width=90 align=center><INPUT TYPE="text" NAME="Two_54" size=10 <?php if ($View_Two_54){echo("value='$View_Two_54'");}?>>원</td>
       </tr>
	   <tr>
         <td align=center width=80>
		      <table border=0 align=center width=100% cellpadding=0 cellspacing=3>
                <tr><td align=center <?php if ($View_Two_45 || $View_Two_46){?>bgcolor='#000000'<?php } ?> height=22><?php if ($View_Two_45 || $View_Two_46){?><font style='color:#FFFFFF; font:bold;'><?}else{?><b><?php } ?>기타</font></td></tr>
               </table>
		 </td>
		 <td nowrap>
		 ...
		 <td width=90 align=center><INPUT TYPE="text" NAME="Two_55" size=10 <?php if ($View_Two_55){echo("value='$View_Two_55'");}?>>원</td>
       </tr>
     </table>
