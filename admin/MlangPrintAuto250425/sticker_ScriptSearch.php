...
?>
<?php
// Initialize the $RadOne variable
$RadOne = isset($RadOne) ? $RadOne : '';

// Inside your HTML:
?>
<option value='<?php echo  htmlspecialchars($row['no']) ?>' <?php if ($RadOne == $row['no']) { echo "selected style='font-size:10pt; background-color:#429EB2; color:#FFFFFF;'"; } ?>>
