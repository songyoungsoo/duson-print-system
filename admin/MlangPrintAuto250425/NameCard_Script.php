...
<tr>
<td bgcolor="#<?php echo  htmlspecialchars($Bgcolor1 ?? 'FFFFFF') ?>" width="100" class="Left1" align="right">대분류&nbsp;&nbsp;</td>
<td>
...
<tr>
<td bgcolor="#<?php echo  htmlspecialchars($Bgcolor1 ?? 'FFFFFF') ?>" width="100" class="Left1" align="right">중분류&nbsp;&nbsp;</td>
<td>
<select name="myList">
    <option value="#">:::::: 선택하십시오 ::::::</option>
    <?php
