...
<html>
<head>
<title>주소자동검색-<?php echo $admin_name?></title>
<STYLE>
<!--
...
<input type='hidden' name='DbDir' value='<?php echo $DbDir?>'>
...
Copyright ⓒ 2003 <?php echo $admin_name?> Corp. All rights reserved. 
</font>
</td></tr>
...
-->
		...
		function Copy(zip,zip1,zip2) {
			...
			top.opener.document.<?php echo $formname?>.zip.value = zip;
			top.opener.document.<?php echo $formname?>.zip1.value = zip1;
			top.opener.document.<?php echo $formname?>.zip2.value = zip2;

			top.opener.document.<?php echo $formname?>.zip2.focus();
