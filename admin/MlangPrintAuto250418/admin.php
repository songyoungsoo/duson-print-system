...
if ($mode == "AdminMlangOrdertOk") {
    ...
    $TypeAll = trim("$Type_1\n$Type_2\n$Type_3\n$Type_4\n$Type_5\n$Type_6");
    $stmt = $mysqli->prepare("INSERT INTO MlangOrder_PrintAuto (no, Type, ImgFolder, Type_1, money_1, money_2, money_3, money_4, money_5, name, email, zip, zip1, zip2, phone, Hendphone, delivery, bizname, bank, bankname, cont, regdate, state, ThingCate, pass, memo, Designer) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
