...
<body LEFTMARGIN='10' TOPMARGIN='10' MARGINWIDTH='10' MARGINHEIGHT='10'>
     ...
     <table border=0 align=center cellpadding=0 cellspacing=0 width=540>
...
<?php if ($EEE=="1"){ $View_Tree_7Ok=$View_Tree_7 * 10/100; ?>
				   <b>�հ�ݾ�&nbsp;<big><?$T = $View_Tree_7+$View_Tree_7Ok; $T = number_format($T);  echo("$T"); $T = str_replace(",","",$T);?></big>&nbsp;��</b>
<?}else{?>
<b>�հ�ݾ�&nbsp;<big><?$T = "$View_Tree_7"; $T = number_format($T);  echo("$T"); $T = str_replace(",","",$T);?></big>&nbsp;��</b>
<?php } ?>
				 <?php if ($EEE=="1"){?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;�ΰ���: <?$T = "$View_Tree_7Ok"; $T = number_format($T);  echo("$T"); $T = str_replace(",","",$T);?>��<?php } ?></font>
                  </td>
               </tr>
             </table>
	   ...
	   <tr>
         <td>
          ...
          <tr><td width=100% height=10></td></tr></table>
		   <table border=1 align=center width=100% cellpadding=0 cellspacing=0>
            <tr>
              <td align=center width=30%><font style='font-size:11pt;'>���</font></td>
			  <td width=70% height=100><?php echo $View_cont?></td>
            </tr>
            </table>
			<table border=0 align=center width=100% cellpadding=0 cellspacing=0>
            <tr>
