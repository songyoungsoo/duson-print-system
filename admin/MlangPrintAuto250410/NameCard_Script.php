...
<tr>
<td bgcolor="#<?php echo  htmlspecialchars($Bgcolor1 ?? 'FFFFFF') ?>" width="100" class="Left1" align="right">��з�&nbsp;&nbsp;</td>
<td>
...
<tr>
<td bgcolor="#<?php echo  htmlspecialchars($Bgcolor1 ?? 'FFFFFF') ?>" width="100" class="Left1" align="right">�ߺз�&nbsp;&nbsp;</td>
<td>
<select name="myList">
    <option value="#">:::::: �����Ͻʽÿ� ::::::</option>
    <?php
