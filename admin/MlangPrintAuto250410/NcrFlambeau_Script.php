...
<select name=myList>
<option value='#'>:::::: 선택하세요 ::::::</option>
<?php if ($code=="Modify"){if($MlangPrintAutoFildView_Section){echo("<option value='$MlangPrintAutoFildView_Section' selected style='font-size:10pt; background-color:#429EB2; color:#FFFFFF;'>");?><? include"../../db.php";
...
<tr>
<td bgcolor='#<?php echo $Bgcolor1?>' width=100 class='Left1' align=right>색상및재질&nbsp;&nbsp;</td>
<td>
<select name=myListTreeSelect>
<option value='#'>:::::: 선택하세요 ::::::</option>
<?php if ($code=="Modify"){if($MlangPrintAutoFildView_TreeSelect){echo("<option value='$MlangPrintAutoFildView_TreeSelect' selected style='font-size:10pt; background-color:#429EB2; color:#FFFFFF;'>");?><? include"../../db.php";
