...
if ($MlangPrintAutoFild_row) {
    ...
    $MlangPrintAutoFildView_TreeSelect = htmlspecialchars($MlangPrintAutoFild_row['TreeSelect']);
    ...
    $MlangPrintAutoFildView_quantityTwo = htmlspecialchars($MlangPrintAutoFild_row['quantityTwo']);
} else {
    echo ("<script>
