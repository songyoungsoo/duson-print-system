...
<tr>
    <td bgcolor="#<?php echo htmlspecialchars($Bgcolor1)?>" width=100 class="Left1" align=right>카테고리&nbsp;&nbsp;</td>
    <td>
...
<tr>
    <td bgcolor="#<?php echo htmlspecialchars($Bgcolor1)?>" width=100 class="Left1" align=right>포맷 선택&nbsp;&nbsp;</td>
    <td>
        <select name="myListTreeSelect">
            <option value="#">:::::: 선택하세요 ::::::</option>
            <?php if (isset($code) && $code == "Modify" && isset($MlangPrintAutoFildView_TreeSelect)) { ?>
...
<tr>
    <td bgcolor="#<?php echo htmlspecialchars($Bgcolor1)?>" width=100 class="Left1" align=right>설계 회사&nbsp;&nbsp;</td>
    <td>
        <select name="myList">
            <option value="#">:::::: 선택하세요 ::::::</option>
