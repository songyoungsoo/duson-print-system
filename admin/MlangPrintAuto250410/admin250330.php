...
if ($mode == "ModifyOk") { ////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if (!$result) {
        ...
        echo ("
            ...
            <meta http-equiv='Refresh' content='0; URL=" . htmlspecialchars($_SERVER['PHP_SELF']) . "?mode=OrderView&no=$no'>
            <meta charset='euc-kr'>
        ");
        exit;
    }
...
if ($mode == "SubmitOk") { ////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    echo ("
        ...
        <meta http-equiv='Refresh' content='0; URL=" . htmlspecialchars($_SERVER['PHP_SELF']) . "?mode=OrderView&no=$new_no'>
        <meta charset='euc-kr'>
    ");
    exit;
} /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
?>
    ...
    <body LEFTMARGIN='0' TOPMARGIN='0' MARGINWIDTH='0' MARGINHEIGHT='0' class='coolBar'>
        ...
        <table border=0 align=center width=100% cellpadding=5 cellspacing=5>
            ...
            <form name='myForm' method='post' <?php if ($code == "Text") {
                                            } else { ?>OnSubmit='javascript:return MemberXCheckField()' <?php } ?> action='<?php echo  htmlspecialchars($_SERVER['PHP_SELF']) ?>'>
                ...
                ?>
                        <tr>
                            <td bgcolor='#<?php echo  $Bgcolor1 ?>' width=100 class='Left1' align=right><?php echo  htmlspecialchars($Si_LIST_script[$k]) ?>&nbsp;&nbsp;</td>
                            <td><TEXTAREA NAME="ContText_<?php echo  $kt ?>" ROWS="4" COLS="58"><?php $temp = "View_ContText_" . $kt;
                                                                                        $get_temp = $$temp;
                                                                                        echo htmlspecialchars($get_temp); ?></TEXTAREA></td>
                        </tr>
                <?php
                        $k = $k + 1;
                        $kt = $kt + 1;
...
if ($mode == "BankModifyOk") {
    ...
    <meta http-equiv='Refresh' content='0; URL=" . htmlspecialchars($_SERVER['PHP_SELF']) . "?mode=BankForm'>
    ");
    exit;
} ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ?>
            ...
            <table border=0 align=center width=100% cellpadding=5 cellspacing=0>
                <tr>
                    <td height="20">
                        ...
                        <a href='download.php?downfile=<?php echo  htmlspecialchars($row['ThingCate']) ?>'><?php echo  htmlspecialchars($row['ThingCate']) ?></a>
                        <?php
            ...
            <body LEFTMARGIN='0' TOPMARGIN='0' MARGINWIDTH='0' MARGINHEIGHT='0' class='coolBar'>
                ...
                <table border=0 align=center width=100% cellpadding='8' cellspacing='1' >
                    ...
                    <form name='MlangFriendSiteInfo' method='post' enctype='multipart/form-data' OnSubmit='javascript:return MlangFriendSiteCheckField()' action='<?php echo  htmlspecialchars($_SERVER['PHP_SELF']) ?>'>
                        ...
                        <tr>
                            <td  colspan=2><font style='color:#FFFFFF; font:bold;'>교정/시안 - 등록/수정</font></td>
                            </td>
