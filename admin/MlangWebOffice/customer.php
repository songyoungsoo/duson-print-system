...
<input type='button' onClick="javascript:popup=window.open('./customer/admin.php?mode=form', 'WebOffice_customerForm','width=600,height=400,top=0,left=0,menubar=no,resizable=no,statusbar=no,scrollbars=yes,toolbar=no'); popup.focus();" value=' ���� �Է��ϱ� '>
</td>
</tr>
</table>
...
��</font></td>
<td align=center>
<input type='button' onClick="javascript:popup=window.open('./customer/admin.php?mode=view&no=<?php echo $row[no]?>', 'WebOffice_customerView','width=650,height=600,top=0,left=0,menubar=no,resizable=no,statusbar=no,scrollbars=yes,toolbar=no'); popup.focus();" value='�����ڼ�������'>
<input type='button' onClick="javascript:popup=window.open('./customer/admin.php?mode=form&code=modify&no=<?php echo $row[no]?>', 'WebOffice_customerModify','width=600,height=400,top=0,left=0,menubar=no,resizable=no,statusbar=no,scrollbars=yes,toolbar=no'); popup.focus();" value=' ���� '>
