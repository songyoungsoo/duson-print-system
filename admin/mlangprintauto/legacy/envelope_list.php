...
// include"../../db.php";
$TIO_CODE="envelope";
$table="mlangprintauto_envelope"; // ✅ 소문자 테이블명
...
<?php 
$result_FGTwo=mysqli_query($db, "select * from $GGTABLE where Ttable='envelope' AND no='{$row['style']}'");
...
<td align=center><font color=white>
<?php 
$result_FGOne=mysqli_query($db, "select * from $GGTABLE where Ttable='envelope' AND no='{$row['Section']}'");
