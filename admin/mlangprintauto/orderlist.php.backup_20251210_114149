...
<div class="order-header">
    <div class="order-header-content">
        ...
        <div class="order-header-buttons">
            ...
            <a href="/shop_admin/delivery_manager.php" class="btn btn--logen" target="_blank">
                🚚 로젠업무
            </a>
            <a href="https://logis.ilogen.com/common/html/main.html" class="btn btn--logen-external" target="_blank">
                📦 로젠택배
            </a>
        </div>
    </div>
