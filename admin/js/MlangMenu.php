...
oCMenu.makeMenu('top4','','인쇄업무프로그램')
    ...
    oCMenu.makeMenu('sub4_1','top4','<?php echo $MenuSubIcon?>자동견적프로그램')
	     ...
	     oCMenu.makeMenu('sub4_1_10','sub4_1','<?php echo $MenuSubIcon?>자동견적 주문','<?php echo $M123; ?>/MlangPrintAuto/OrderList.php')
	     ...
	     oCMenu.makeMenu('sub4_1_12','sub4_1','<?php echo $MenuSubIcon?>자동견적  통합관리','<?php echo $M123; ?>/MlangPrintAuto/admin.php?mode=BankForm&code=Text','Mlang')
