...
// echo $POtype = isset($_GET['POtype']) ? $_GET['POtype'] : '';
...
// 합당한 가격을 검색하여 보내기
$query = "SELECT * FROM $TABLE WHERE style='$MY_type' and Section='$PN_type' and TreeSelect='$MY_Fsd' and quantity='$MY_amount'";
// echo $query; // 디버깅용
$result = mysqli_query($db, $query);
if (!$result) {
    echo "쿼리 오류: " . mysqli_error($db);
    exit;
}
