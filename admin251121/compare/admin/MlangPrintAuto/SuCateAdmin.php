...
$result= mysql_query("select * from $GGTABLESu where no='$no'",$db);
$row= mysql_fetch_array($result);

if($row[BigNo]=="0"){

mysql_query("DELETE FROM $GGTABLESu WHERE BigNo='$no'");
mysql_query("DELETE FROM $GGTABLESu WHERE no='$no'");
mysql_close();
