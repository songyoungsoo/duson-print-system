<?
   $MlangPrintAutoFild_result= mysql_query("select * from MlangPrintAuto_MerchandiseBond where no='$no'",$db);
   $MlangPrintAutoFild_row= mysql_fetch_array($MlangPrintAutoFild_result);
