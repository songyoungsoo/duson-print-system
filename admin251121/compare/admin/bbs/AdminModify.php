...
include"../../db.php";
$result= mysql_query("select * from Mlnag_BBS_Admin where no='$no'",$db);
...
f.NoticeStyleSu.value="<?=$BBS_ADMIN_NoticeStyleSu?>";
} 
...
<form name='BBSAdminModify' method='post' OnSubmit='javascript:return BBSAdminModifyCheckField()' action='<?=$PHP_SELF?>'>
<INPUT TYPE='hidden' NAME='code'  VALUE="ok">
<INPUT TYPE='hidden' NAME='no'  VALUE="<?=$BBS_ADMIN_no?>">
...
<td width=80% bgcolor='#575757'>
<INPUT TYPE='TEXT' SIZE=40 maxLength='100' NAME='title'  VALUE="<?=$BBS_ADMIN_title?>">
</td>
</tr>
...
<td width=80% bgcolor='#575757'>
<INPUT TYPE='TEXT' SIZE=20 maxLength='20' NAME='pass'  VALUE="<?=$BBS_ADMIN_pass?>">
</td>
</tr>
...
<td width=80% bgcolor='#575757'>
<INPUT TYPE='TEXT' SIZE=10 maxLength='10' NAME='MAXFSIZE'  VALUE="<?=$BBS_ADMIN_MAXFSIZE?>"> KB
</td>
</tr>
...
<td width=80% bgcolor='#575757'>
<INPUT TYPE='TEXT' SIZE=5 maxLength='3' NAME='recnum'  VALUE="<?=$BBS_ADMIN_recnum?>"> 개
</td>
</tr>
...
<td width=80% bgcolor='#575757'>
<INPUT TYPE='TEXT' SIZE=5 maxLength='3' NAME='lnum'  VALUE="<?=$BBS_ADMIN_lnum?>"> 개
</td>
</tr>
...
<td width=80% bgcolor='#575757'>
<INPUT TYPE='TEXT' SIZE=5 maxLength='3' NAME='cutlen'  VALUE="<?=$BBS_ADMIN_cutlen?>"> 자 (공백을 포함함)
</td>
</tr>
...
<td width=80% bgcolor='#575757'>
<INPUT TYPE='TEXT' SIZE=5 maxLength='1' NAME='New_Article'  VALUE="<?=$BBS_ADMIN_New_Article?>"> 일
</td>
</tr>
...
<td width=80% bgcolor='#575757'>
<INPUT TYPE='radio' NAME='secret_select'  VALUE="yes" <? if($BBS_ADMIN_secret_select=="yes"){echo("checked");} ?>>사용함
<INPUT TYPE='radio' NAME='secret_select'  VALUE="no" <? if($BBS_ADMIN_secret_select=="no"){echo("checked");} ?>>사용 안함
</td>
</tr>
...
<td width=80% bgcolor='#575757'>
<INPUT TYPE='radio' NAME='write_select'  VALUE="member" <? if($BBS_ADMIN_write_select=="member"){echo("checked");} ?>>회원들
<INPUT TYPE='radio' NAME='write_select'  VALUE="guest" <? if($BBS_ADMIN_write_select=="guest"){echo("checked");} ?>>아무나
<INPUT TYPE='radio' NAME='write_select'  VALUE="admin" <? if($BBS_ADMIN_write_select=="admin"){echo("checked");} ?>>관리자만
</td>
</tr>
...
<td width=80% bgcolor='#575757'>
<INPUT TYPE='radio' NAME='view_select'  VALUE="member" <? if($BBS_ADMIN_view_select=="member"){echo("checked");} ?>>회원들
<INPUT TYPE='radio' NAME='view_select'  VALUE="guest" <? if($BBS_ADMIN_view_select=="guest"){echo("checked");} ?>>아무나
<INPUT TYPE='radio' NAME='view_select'  VALUE="admin" <? if($BBS_ADMIN_view_select=="admin"){echo("checked");} ?>>관리자만
</td>
</tr>
...
<option value='2' <? if($BBS_ADMIN_BBS_Level=="2"){echo("selected");} ?>>2 레벨-부운영자</option>
<option value='3' <? if($BBS_ADMIN_BBS_Level=="3"){echo("selected");} ?>>3 레벨-골드회원</option>
<option value='4' <? if($BBS_ADMIN_BBS_Level=="4"){echo("selected");} ?>>4 레벨-정회원</option>
<option value='5' <? if($BBS_ADMIN_BBS_Level=="5"){echo("selected");} ?>>5 레벨-일반회원</option>
</SELECT>
...
<td width=80% bgcolor='#575757'>
<INPUT TYPE='TEXT' SIZE=10 maxLength='20' NAME='td_width'  VALUE="<?=$BBS_ADMIN_td_width?>">
( 예: 800 또는 100% )
</td>
</tr>
...
<td width=80% bgcolor='#575757'>
<INPUT TYPE='TEXT' SIZE=10 maxLength='20' NAME='td_color1'  VALUE="<?=$BBS_ADMIN_td_color1?>">
( 예: FFCCCC 또는 green )
</td>
</tr>
...
<td width=80% bgcolor='#575757'>
<INPUT TYPE='TEXT' SIZE=10 maxLength='20' NAME='td_color2'  VALUE="<?=$BBS_ADMIN_td_color2?>">
( 예: FFFFFF 또는 white )
</td>
</tr>
...
<textarea cols=64 name=header rows=8><?=$BBS_ADMIN_header?></textarea>
</td>
</tr>
...
<td width=80% bgcolor='#575757'>
<font style='font-size:8pt;'>* 파일의 경로만 입력하세요..( 예: 도메인명/폴더명/test.htm )</font><BR>
<INPUT TYPE='TEXT' SIZE=40 NAME='header_include'  VALUE="<?=$BBS_ADMIN_header_include?>">
</td>
</tr>
...
<td width=80% bgcolor='#575757'>
<font style='font-size:8pt;'>* 아래의 내용은 include 보다 위에 위치합니다....</font><BR>
<textarea cols=64 name=footer rows=8><?=$BBS_ADMIN_footer?></textarea>
</td>
</tr>
...
<td width=80% bgcolor='#575757'>
<font style='font-size:8pt;'>* 파일의 경로만 입력하세요..( 예: 도메인명/폴더명/test.htm )</font><BR>
<INPUT TYPE='TEXT' SIZE=40  NAME='footer_include'  VALUE="<?=$BBS_ADMIN_footer_include?>">
</td>
</tr>
...
<INPUT TYPE='TEXT' SIZE=5  NAME='PointView'  VALUE="<?=$BBS_ADMIN_PointBoardView?>">
</td>
</tr>
...
<INPUT TYPE='TEXT' SIZE=5  NAME='PointWrite'  VALUE="<?=$BBS_ADMIN_PointBoard?>">
</td>
</tr>
...
<INPUT TYPE='TEXT' SIZE=5  NAME='ComentWrite'  VALUE="<?=$BBS_ADMIN_PointComent?>">
</td>
</tr>
...
<INPUT TYPE='TEXT' SIZE=60  NAME='cate'  VALUE="<?=$BBS_ADMIN_cate?>">
</td>
</tr>
...
<td width=80% bgcolor='#575757'>
<input type="text" name="NoticeStyleSu" size="5" VALUE="<?=$BBS_ADMIN_NoticeStyleSu?>">&nbsp;개
<input type="hidden" name="NoticeStyleSuNO" size="5" VALUE="<?=$BBS_ADMIN_NoticeStyleSu?>">
</td>
</tr>
...
include"../../db.php";
$query ="UPDATE Mlnag_BBS_Admin SET 
title='$title',
pass='$pass',
skin='$skin',
header='$header',
