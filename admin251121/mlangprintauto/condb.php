...
if ($ListXTtable == "2" || $Ttable == "namecard" || $Ttable == "NameCard" || $ToTitle == "명함") {
    $View_TtableA = "2";
    $View_TtableB = "namecard";
    $View_TtableC = "명함";
}
if ($ListXTtable == "3" || $Ttable == "merchandisebond" || $Ttable == "MerchandiseBond" || $ToTitle == "상품권") {
    $View_TtableA = "3";
...
if ($ListXTtable == "5" || $Ttable == "ncrflambeau" || $Ttable == "NcrFlambeau" || $ToTitle == "양식지") {
    $View_TtableA = "5";
...
if ($ListXTtable == "7" || $Ttable == "littleprint" || $Ttable == "LittlePrint" || $ToTitle == "소량인쇄") {
    $View_TtableA = "7";
    $View_TtableB = "littleprint";
    $View_TtableC = "소량인쇄";
}
if ($ListXTtable == "8" || $Ttable == "cadaroktwo" || $Ttable == "cadarokTwo" || $ToTitle == "카다로그") {
    $View_TtableA = "8";
