...
<td> 
<input type="radio" onClick="javascript:window.location.href='<?echo("$PHP_SELF");?>?mode=<?echo("$mode");?>&code=br&no=<?echo("$no");?>';" name='style' value='br' <?if($code=="br"){echo("checked");}else{if($TT_style=="br"){echo("checked");}}?>>BR자동입력
...
<textarea cols=72 name=connent rows=30><?php if($TT_style=="br"){echo("$TT_connent");}
?></textarea>
</td>
</tr>
