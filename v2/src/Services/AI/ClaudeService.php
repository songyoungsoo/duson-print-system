...
class ClaudeService
{
    ...
    {
        $this->apiKey = $apiKey ?? $_ENV['CLAUDE_API_KEY'] ?? getenv('CLAUDE_API_KEY') ?: '';
    }
...
{
  "copies": [
    {"head": "헤드카피1", "sub": "서브카피1"},
    {"head": "헤드카피2", "sub": "서브카피2"},
    {"head": "헤드카피3", "sub": "서브카피3"},
    {"head": "헤드카피4", "sub": "서브카피4"},
    {"head": "헤드카피5", "sub": "서브카피5"}
  ]
}
PROMPT;
    }
