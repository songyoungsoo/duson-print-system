...
<td class="order-table-td">
<button type="button" class="btn btn--sm btn--secondary" onClick="javascript:popup=window.open('/admin/mlangprintauto/admin.php?mode=SinForm&coe&no=<?php echo $row['no'] ?><?php if ($row['ThingCate']) { ?>&ModifyCode=ok<?php } ?>', 'SinHH','width=600,height=100,top=0,left=0,menubar=no,resizable=no,statusbar=no,scrollbars=yes,toolbar=no'); popup.focus();">
