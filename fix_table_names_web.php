<?php
/**
 * 향상된 테이블명 대소문자 일괄 수정 스크립트 (웹 실행 버전)
 * 백업 생성, 롤백 기능, 향상된 검증 및 로깅 포함
 */

// 웹 실행 환경에서만 동작
if (php_sapi_name() === 'cli') {
    die("이 스크립트는 웹 브라우저에서 실행해주세요: http://localhost/fix_table_names_web.php\n");
}
...
?>";
    ...
    addMessage("롤백 스크립트 생성: rollback_table_changes.php", 'info');
}
...
<head>
    ...
    <title>테이블명 수정 도구 (Enhanced & Safe)</title>
    <style>
        body {
    ...
    <div class="container">
        ...
        <?php if (!$execute): ?>
            ...
            <div class="config-box">
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    <tr style="background: #34495e; color: white;">
                        <th style="padding: 8px; border: 1px solid #ddd;">현재 (소문자)</th>
                        <th style="padding: 8px; border: 1px solid #ddd;">변경 후 (정확한 대소문자)</th>
                    </tr>
            ...
            <div style="text-align: center; margin-top: 30px;">
                <a href="?execute=yes" class="btn btn-success">🚀 실행하기</a>
        ...
        <?php else: ?>
            ...
            <div class="config-box">
                ...
                <p><strong>롤백 스크립트:</strong> rollback_table_changes.php</p>
            </div>
            ...
            <div style="text-align: center; margin-top: 30px;">
                <a href="rollback_table_changes.php" class="btn btn-danger">🔄 롤백 실행</a>
