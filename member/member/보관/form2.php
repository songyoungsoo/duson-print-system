...
<td>
<input type='password' name='pass1' size='10'  maxlength="12" <?php if
($MdoifyMode=="view"){echo("value='$MlangMember_pass'");}?>>
&nbsp;
<font style='font:bold; color:red;'>*</font>
<font style='color:6788A6; font:bold;'>��й�ȣ���Է�</font>&nbsp;
<input type='password' name='pass2' size='10'  maxlength="12" <?php if
($MdoifyMode=="view"){echo("value='$MlangMember_pass'");}?>>
 {��,�������� 4~12����} 
</td>
</tr>
...
<tr>
  ...
  <td>
  <input type='text' name='phone1' size='10'  maxlength="3" <?php if
($MdoifyMode=="view"){echo("value='$MlangMember_phone1'");}?>>
    -
  <input type='text' name='phone2' size='10'  maxlength="4" <?php if
($MdoifyMode=="view"){echo("value='$MlangMember_phone2'");}?>>
    -
  <input type='text' name='phone3' size='10'  maxlength="4" <?php if
...
<td>
<input type='text' name='hendphone1' size='10'  maxlength="3" <?php if
($MdoifyMode=="view"){echo("value='$MlangMember_hendphone1'");}?>>
-
<input type='text' name='hendphone2' size='10'  maxlength="4" <?php if
($MdoifyMode=="view"){echo("value='$MlangMember_hendphone2'");}?>>
-
<input type='text' name='hendphone3' size='10'  maxlength="4" <?php if
...
<td>
<input type='text' name='email' size='30' maxlength="200" <?php if
...
<input type="text" id="sample6_address" name="sample6_address" placeholder="�ּ�"><br>
...
($MdoifyMode=="view"){echo("value='$MlangMember_po5'");}?>><BR>
	<input type="text" name="po6" placeholder="������ּ�"
<?php if
