...
<input type='button' style='font-size:9pt; background-color:#376C9D; color:#00315F; border-style:solid; height:22px; border:1 solid #cccccc;' onClick="javascript:return idcheck();" value='ID�ߺ�Ȯ��'>
{��/���� 4~20��, ����Ұ�}
<?php } ?>
</td>
</tr>
