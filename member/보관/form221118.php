...
<input type='text' name='id' size='15'  maxlength='20' style='background-color:#E8EFF6;'>
<input type='button' style='font-size:9pt; background-color:#376C9D; color:#00315F;' onClick='javascript:idcheck();' value='ID�ߺ�Ȯ��'>
{��/���� 4~20��, ����Ұ�}
<?php } ?>
</td>
</tr>
...
<tr>
  ...
  <td>
  <input type='text' name='phone1' size='10' style='background-color:#E8EFF6; ' maxlength="5" <?php if
($MdoifyMode=="view"){echo("value='$MlangMember_phone1'");}?>>
    -
  <input type='text' name='phone2' size='10' style='background-color:#E8EFF6; ' maxlength="5" <?php if
($MdoifyMode=="view"){echo("value='$MlangMember_phone2'");}?>>
    -
  <input type='text' name='phone3' size='10' style='background-color:#E8EFF6; ' maxlength="5" <?php if
...
<td>
<input type='text' name='hendphone1' size='10' style='background-color:#E8EFF6; ' maxlength="5" <?php if
($MdoifyMode=="view"){echo("value='$MlangMember_hendphone1'");}?>>
-
<input type='text' name='hendphone2' size='10' style='background-color:#E8EFF6; ' maxlength="5" <?php if
($MdoifyMode=="view"){echo("value='$MlangMember_hendphone2'");}?>>
-
<input type='text' name='hendphone3' size='10' style='background-color:#E8EFF6; ' maxlength="5" <?php if
...
<?php if
($MdoifyMode=="view"){echo("value='$MlangMember_sample6_postcode'");}?>>
...
<?php if
($MdoifyMode=="view"){echo("value='$MlangMember_sample6_address'");}?>><br>	
<input type="text" id="sample6_detailAddress" name="sample6_detailAddress" placeholder="���ּ�"
<?php if
($MdoifyMode=="view"){echo("value='$MlangMember_sample6_detailAddress'");}?>>
<input type="text" id="sample6_extraAddress" name="sample6_extraAddress" placeholder="�����׸�"
<?php if
($MdoifyMode=="view"){echo("value='$MlangMember_sample6_extraAddress'");}?>>
...
<?php if
($MdoifyMode=="view"){echo("value='$MlangMember_po1'");}?>><BR>
	<input type="text" name="po2" placeholder="��ȣ"
<?php if
($MdoifyMode=="view"){echo("value='$MlangMember_po2'");}?>><BR>
	<input type="text" name="po3" placeholder="����"
<?php if
($MdoifyMode=="view"){echo("value='$MlangMember_po3'");}?>><BR>
	<input type="text" name="po4" placeholder="����"
<?php if
($MdoifyMode=="view"){echo("value='$MlangMember_po4'");}?>><BR>
	<input type="text" name="po5" placeholder="����"
<?php if
($MdoifyMode=="view"){echo("value='$MlangMember_po5'");}?>><BR>
	<input type="text" name="po6" size='50' placeholder="������ּ�"
<?php if
($MdoifyMode=="view"){echo("value='$MlangMember_po6'");}?>><BR>
</td>
</tr>
