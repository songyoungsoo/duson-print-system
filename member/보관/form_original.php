...
<input type='button' onClick='javascript:idcheck();' value='ID�ߺ�Ȯ��'> {��/���� 4~20��, ����Ұ�}
...
<tr>
  ...
  <td>
  <input type='text' name='phone1' size='10' maxlength="5" <?php if
($MdoifyMode=="view"){echo("value='$MlangMember_phone1'");}?>>
    -
  <input type='text' name='phone2' size='10'  maxlength="5" <?php if
($MdoifyMode=="view"){echo("value='$MlangMember_phone2'");}?>>
    -
  <input type='text' name='phone3' size='10'  maxlength="5" <?php if
...
<td>
<input type='text' name='hendphone1' size='10'  maxlength="5" <?php if
($MdoifyMode=="view"){echo("value='$MlangMember_hendphone1'");}?>>
-
<input type='text' name='hendphone2' size='10'  maxlength="5" <?php if
($MdoifyMode=="view"){echo("value='$MlangMember_hendphone2'");}?>>
-
<input type='text' name='hendphone3' size='10'  maxlength="5" <?php if
