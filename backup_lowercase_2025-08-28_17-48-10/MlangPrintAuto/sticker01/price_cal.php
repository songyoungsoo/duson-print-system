...
$result = mysqli_query($db, "SELECT * FROM $TABLE WHERE style='$MY_type' AND Section='$PN_type' AND quantity='$MY_amount'");
...
<script>
    ...
    // 전단지 옆 장수
    // parent.document.forms["choiceForm"].MY_amountRight.value = "<?= $ViewquantityTwo ?>장";
</script>
