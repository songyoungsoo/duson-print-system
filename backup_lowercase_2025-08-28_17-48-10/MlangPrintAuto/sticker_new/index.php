                    ...
                    <table class="order-form-table">
                        <tbody>
                            <tr>
                                ...
                                <td class="input-cell compact-cell">
                                ...
                                <td class="input-cell compact-cell">
                                    <div class="size-inputs">
                                        <div class="size-input-inline">
                                            ...
                                            <input type="number" name="garo" id="garo" class="form-control-inline size-input-field" placeholder="예: 100" max="560" value="100" required
                                                   onblur="validateSize(this, '가로')">
                                        </div>
                                        <span class="size-multiply">×</span>
                                        <div class="size-input-inline">
                                            <label class="size-label">세로 (mm):</label>
                                            <input type="number" name="sero" id="sero" class="form-control-inline size-input-field" placeholder="예: 100" max="560" value="100" required
