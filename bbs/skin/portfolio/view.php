...
<tr><td width=100% bgcolor='<?php echo $BBS_ADMIN_td_color1?>' ></td></tr> <!--background='/img/left_menu_back_134ko.gif' height=1-->
...
<?php
	if($BbsViewMlang_bbs_file){
     echo("<a href= 'javascript:history.back(1)' title='누르시면 목록으로 갑니다' '/bbs/upload/$table/$BbsViewMlang_bbs_file'><img src='/bbs/upload/$table/$BbsViewMlang_bbs_file' border=0 onload=\"if(this.width>550){this.width=550}\"></a><br>");
	}
...
$NEXT_2no = $row['Mlang_bbs_no'];
echo "<a href='$PHP_SELF?mode=view&table=$table&no=$NEXT_2no&page=$page&PCode=$PCode'>$NEXT_2title</a>";
?>
&nbsp;
</td>
</tr>
...
$NEXT_1no = $row['Mlang_bbs_no'];
echo "<a href='$PHP_SELF?mode=view&table=$table&no=$NEXT_1no&page=$page&PCode=$PCode'>$NEXT_1title</a>";
?>
&nbsp;
</td>
</tr>
