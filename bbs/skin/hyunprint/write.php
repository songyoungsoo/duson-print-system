...
//$Write_Style1="style='background-color:$BBS_ADMIN_td_color2; color:#000000; border-style:solid; border:1 solid; border-color: #CCCCCC;'";
...
<table width='692' border="0" cellpadding="0" cellspacing="1" bgcolor="#D7D7D7">
 <?php // <?php echo $BBS_ADMIN_td_width?>
    <tr bgcolor="#D0A4DF">
...
?>
      ...
      <?php } ?>
      <tr>
        <td  width=90 align=right bgcolor="#F5F5F5"><span class="style3">등록인&nbsp;</span></td>
        <td bgcolor="#FFFFFF"><?php if($BBS_ADMIN_write_select=="member"){if($WebtingMemberLogin_id){?>
            <input type='hidden' name='name' value='<?php echo $WebtingMemberLogin_id?>' />
            <?php echo $WebtingMemberLogin_id?>
            <?php } }else{?>
          &nbsp;
      ...
      <?php }else{?>
      <tr>
        <td align=right bgcolor="#F5F5F5" ><span class="style3">비밀번호&nbsp;</span></td>
        <td bgcolor="#FFFFFF" maxlength='20'>&nbsp;
            <input type='text' name='pass' size='20' <?php echo $Write_Style1?> />
            <font style='font-size:9pt;'>
              <?php if($tt=="modify"){echo("( 글을 등록할 당시의 비밀번호를 입력해주세요.. )");}else{echo("( 글 수정시 필요해요.. )");}?>
            </font></td>
      </tr>
      <?php }?>
      <tr>
        <td align=right bgcolor="#F5F5F5" ><span class="style3">제목&nbsp;</span></td>
        <td bgcolor="#FFFFFF">&nbsp;
            <input type='text' name='title' style="width:70%;" maxlength='100' value='<?php if($tt=="modify"){echo("$BbsViewMlang_bbs_title");}?>' <?php echo $Write_Style1?> /></td>
      </tr>
      <tr>
        <td align=right bgcolor="#F5F5F5" ><span class="style3">문서형식&nbsp;</span></td>
        <td bgcolor="#FFFFFF">&nbsp;
            <select name=style <?php echo $Write_Style1?>>
              ...
              <option value='htmlbr' <?php if($BbsViewMlang_bbs_style=="htmlbr"){echo("selected");}?>>HTML or BR</option>
          </select></td>
      </tr>
      <?php if($BBS_ADMIN_cate){?>
      <tr>
        <td align=right bgcolor="#F5F5F5" ><span class="style3">카테고리&nbsp;</span></td>
        <td bgcolor="#FFFFFF">&nbsp;
            <?php $CateCodeUgt="2";  include "$BbsDir/BBS_CATE.php";?></td>
      </tr>
      <?php }?>
      <?php if($BBS_ADMIN_secret_select=="yes"){ ?>
      <tr>
        <td align=right bgcolor="#F5F5F5" ><span class="style3">공개 여부&nbsp;</span></td>
        <td bgcolor="#FFFFFF"><?php if($tt=="modify"){ ?>
          &nbsp;
          <input type='radio' name='secret' value='yes' <?php if($BbsViewMlang_bbs_secret=="yes"){echo("checked");}?> />
          <b>공개</b> &nbsp;
          <input type='radio' name='secret' value='no' <?php if($BbsViewMlang_bbs_secret=="no"){echo("checked");}?> />
          <b>비공개</b>
          <?php }else{ ?>
          &nbsp;
          <input type='radio' name='secret' value='yes' checked />
          <b>공개</b> &nbsp;
          <input type='radio' name='secret' value='no' />
          <b>비공개</b>
          <?php }?>
          <font style='font-size:9pt;'>( 비공개로 체크하시면 관리자만 글을 볼수 있어요.. )</font></td>
      </tr>
      <?php }?>
      <tr>
        <td align=right bgcolor="#F5F5F5" ><span class="style3">주문내역&nbsp;</span></td>
        <td bgcolor="#FFFFFF" ><?php if($tt=="reply"){ // 답변일경우 //////////////////////////////////////////////////////////////////// ?>
          &nbsp;
...
-----------------------------------------------------------------
          ...
          <?php }else if($tt=="modify"){ // 수정일경우 /////////////////////////////////////////////////////////// ?>
          &nbsp;
          <textarea  name=CONTENT style="overflow:auto; width:98%; height:300; line-height:130%;" <?php echo $Write_Style1?>><?php echo htmlspecialchars($BbsViewMlang_bbs_connent);?>
</textarea>
          <?php }else{ // 아무것도 없음 쓰기로 ////////////////////////////////////////////////////////////////// ?>
          &nbsp;
      ...
      <tr>
        <td align=right bgcolor="#F5F5F5" ><span class="style3">전화번호&nbsp;</span></td>
        <td bgcolor="#FFFFFF">&nbsp;
            <input type='text' name='link' style="width:40%;" value='<?php if($tt=="modify"){echo("$BbsViewMlang_bbs_link");}?>' <?php echo $Write_Style1?> /></td>
      </tr>
      <?php }?>
      <?php if($BBS_ADMIN_file_select=="yes"){ ?>
      <tr>
        <td align=right bgcolor="#F5F5F5" ><span class="style3">첨부파일&nbsp;</span></td>
        <td bgcolor="#FFFFFF"><?php if($tt=="modify"){echo("<font style='font-size:9pt;'>&nbsp;<input type='checkbox' name='uploadModify' value='yes'>파일을 변경하시려면 체크후 업로드하세요..!!</font>&nbsp;&nbsp;<font style='font-size:9pt; color:$BBS_ADMIN_td_color1;'>저장되어 있는 파일명: $BbsViewMlang_bbs_file</font><BR>");}?>
          &nbsp;
          <input type='file' name='upfile' style="width:70%;" <?php echo $Write_Style1?> /></td>
      </tr>
      <?php }?>
      <tr bgcolor="#F5F5F5">
...
?>
      ...
      <tr>
        <td align=right bgcolor="#F5F5F5" ><span class="style4">공지출력여부</span><span class="style3">&nbsp;</span></td>
        <td bgcolor="#FFFFFF"><?php if ($BbsViewMlang_bbs_NoticeStyle == "yes") { ?>
            <input type='radio' name='NoticeStyle' value='yes' checked />
          <b>YES</b>
            <input type='radio' name='NoticeStyle' value='no' />
          <b>NO</b>
            <?php } else { ?>
            <input type='radio' name='NoticeStyle' value='yes' />
          <b>YES</b>
            <input type='radio' name='NoticeStyle' value='no' checked />
          <b>NO</b>
            <?php } ?>
            <font style='font-size:9pt;'>( Yes로 체크를 하시면 게시판 상단의 공지 글로 호출 됩니다.)</font></td>
      </tr>
      <?php } } ?>
      <?php mysqli_close($db); } /////////////////////////// 관리자 모드 호출 END    ////////////////// ?>
      <tr>
        <td  align=right bgcolor="#F5F5F5"><span class="style4">글쓰기 확인</span><span class="style3">&nbsp;</span></td>
        <td bgcolor="#FFFFFF">&nbsp;
...
#cssfont {width:150; height:20; color:#0099CC; font-size:20pt; font:bold; line-height:100%;} 
            ...
            <span id=cssfont  onselectstart="return false" ondragstart="return false" style="Filter: Blur(Add=1, Direction=225, Strength=7)"> <i><?php echo $num ?></i></span> </td>
      </tr>
      <tr>
        <td colspan=2 bgcolor="#FFFFFF"><p align=center>
            <?php if ($tt == "modify") { ?>
            ...
            <p align=CENTER><font style='color:#585858'>현 게시판은 불법 스팸 게시판 등록프로그램의 불법 게시글을 방지하기 위하여<br />
              입력시간이 10초이상이어야 글을 등록하실수 있습니다... </font></p></td>
      </tr>
    </form>
</table>
<?php } ?>
...
// 문법 오류 없음. mysqli_close($db);는 올바른 PHP 함수 사용입니다.
mysqli_close($db);
