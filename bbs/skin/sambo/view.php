...
<a href='#' onClick="javascript:popup=window.open('<?php echo $Homedir?>/bbs/count.php?mode=req&table=<?php echo $table?>&no=<?php echo $no?>', 'bbs_count','width=200,height=200,top=2000,left=2000,menubar=yes,resizable=yes,statusbar=no,scrollbars=yes,toolbar=no'); popup.focus();"><img src='<?php echo $Homedir?>/bbs/skin/<?php echo $BBS_ADMIN_skin?>/img/req.gif' border=0 align=absmiddle></a>
<?php }?>

<a href='#' onClick="javascript:window.open('<?php echo $Homedir?>/bbs/bbs_printer.php?table=<?php echo $table?>&no=<?php echo $no?>', 'bbs_printer','width=780,height=600,top=0,left=0,menubar=no,resizable=yes,statusbar=no,scrollbars=yes,toolbar=no');"><img src='<?php echo $Homedir?>/bbs/skin/<?php echo $BBS_ADMIN_skin?>/img/printer.gif' border=0 align=absmiddle></a>
