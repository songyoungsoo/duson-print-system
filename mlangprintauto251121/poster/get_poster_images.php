 ...
 * ImgFolder/poster/gallery/ 경로에서 이미지를 가져옴
 */
...
try {
    $category = isset($_GET['category']) ? $_GET['category'] : 'poster';
    ...
    $galleryPath = $_SERVER['DOCUMENT_ROOT'] . '/ImgFolder/poster/gallery/';
    $webPath = '/ImgFolder/poster/gallery/';
    ...
    if (empty($images)) {
        ...
        for ($i = 1; $i <= 4; $i++) {
            $images[] = [
                ...
                'path' => '/images/samples/poster_sample_' . $i . '.jpg',
                'image_path' => '/images/samples/poster_sample_' . $i . '.jpg',
                'thumbnail' => '/images/samples/poster_sample_' . $i . '.jpg',
                'thumbnail_path' => '/images/samples/poster_sample_' . $i . '.jpg',
                'thumb_path' => '/images/samples/poster_sample_' . $i . '.jpg',
                'url' => '/images/samples/poster_sample_' . $i . '.jpg',
                'thumb' => '/images/samples/poster_sample_' . $i . '.jpg',
                'category' => '포스터',
                'is_default' => true
            ];
        }
