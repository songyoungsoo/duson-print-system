    ...
    <style>
        * {
        ...
        .main-container {
            ...
            gap: 2rem;
            padding: 0 2rem;
            padding-right: 130px; /* 우측 고정 사이드바 공간 확보 */
        }
        ...
        /* 오른쪽 사이드바 - right.php에서 스타일 정의 (position: fixed) */
        /* main.php의 그리드 밖에서 독립적으로 표시됨 */
        ...
        @media (max-width: 1024px) {
            .main-container {
                ...
                gap: 1rem;
                padding-right: 2rem; /* 고정 사이드바 숨김시 패딩 복원 */
            }
            ...
            /* right-sidebar는 right.php에서 1024px 이하 숨김 처리 */
