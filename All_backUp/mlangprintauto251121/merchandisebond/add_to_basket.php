...
try {
    ...
    error_log("upload_path_manager.php 포함 시작");
    include "../../includes/upload_path_manager.php";
    error_log("upload_path_manager.php 포함 완료");
...
try {
    // 레거시 경로 생성
    $upload_path_info = generateUploadPath('merchandisebond');
    ...
    error_log("상품권 파일 업로드 오류: " . $e->getMessage());
