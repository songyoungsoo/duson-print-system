...
<script language="JavaScript" src="./selScript.js"></script>
<style type="text/css">
...
<form action="estimate_auto_PC.php" method="post" name="ordform" id="ordform" enctype="multipart/form-data" onSubmit="return  formChk()">
      ...
      <table width="692" border="0" cellpadding="0" cellspacing="1" bgcolor="#D7D7D7">
        <tr> 
          ...
          <td width="568" bgcolor="#FFFFFF"> &nbsp; <select name="paper" id="paper" onChange="selPaper()">
              <option>▒ 용지를 선택해 주세요 ▒</option>
              <option value="1">무코팅지/코팅</option>
              <option value="2">휘라레/반누브</option>
              <option value="3">그레이스</option>
              <option value="4">빌리지/스타지/머쉬지/스코지/키칼지</option>
              <option value="5">플래티넘</option>
            </select> </td>
        </tr>
        <tr> 
          <td height="25" bgcolor="#F5F5F5"><div align="center"><font color="#666666">규격</font></div></td>
          <td width="568" bgcolor="#FFFFFF"> &nbsp; <select name="size" id="size" onChange="calc()">
              <option value="1">단면</option>
              <option value="2">양면</option>
            </select> </td>
        </tr>     
		<tr><td height="0" colspan=2><!--코팅메뉴 숨김 --><div  id="coatingA" style="visibility:visible;"> 
          ...
          <td  bgcolor="#FFFFFF"> &nbsp; <select name="coating" id="coating">
                      <option value="1">무코팅</option>
                      <option value="2">코팅</option>
		...
		<tr> 
          ...
          <td width="568" height="25" bgcolor="#FFFFFF">
            ...
            <div id='cntA0' style='visibility:visible;'>
			 &nbsp; <select name="cnt0" id="cnt">
              <option>▒ 수량 ▒</option>
            </select></div>
            <!--1. 무코팅/코팅 수량 -->
            <div id='cntA1' style='visibility:hidden;position:absolute;'>
			 &nbsp; <select name="cnt1" class="input"  bgcolor=white onchange="calc(this);">
              <option selected>:: 수량 ::</option>
              <option value="500" >500 매</option>
              <option value="1000" >1,000 매</option>
              <option value="2000" >2,000 매</option>
              <option value="3000" >3,000 매</option>
              <option value="4000" >4,000 매</option>
              <option value="5000" >5,000 매</option>
              <option value="10000" >10,000 매</option>
              <option value="20000" >20,000 매</option>
              <option value="50000" >50,000 매</option>
              <option value="100000" >100,000 매</option>
            </select></div>
            <!--2. 휘라레/반누브 -->
            <div id='cntA2' style='visibility:hidden;position:absolute;'>
			 &nbsp; <select name="cnt2" class="input"  bgcolor=white onchange="calc(this);">
              <option selected>:: 수량 ::</option>
              <option value="300" >300 매</option>
              <option value="600" >600 매</option>
              <option value="900" >900 매</option>
              <option value="1200" >1,200 매</option>
              <option value="1500" >1,500 매</option>
              <option value="5000" >5,000 매</option>
              <option value="10000" >10,000 매</option>
              <option value="50000" >50,000 매</option>
            </select></div>
            <!--3. 그레이스 -->
            <div id='cntA3' style='visibility:hidden;position:absolute;'>
			 &nbsp; <select name="cnt3" class="input"  bgcolor=white onchange="calc(this);">
              <option selected>:: 수량 ::</option>
              <option value="200" >200 매</option>
              <option value="400" >400 매</option>
              <option value="600" >600 매</option>
              <option value="800" >800 매</option>
              <option value="1000" >1,000 매</option>
              <option value="2000" >2,000 매</option>
              <option value="5000" >5,000 매</option>
              <option value="10000" >10,000 매</option>
            ...
            <!--4. 빌리지/스타지... -->
            <div id='cntA4' style='visibility:hidden;position:absolute;'>
			 &nbsp; <select name="cnt4" class="input"  bgcolor=white onchange="calc(this);">
              <option selected>:: 수량 ::</option>
              <option value="200" >200 매</option>
              <option value="400" >400 매</option>
              <option value="600" >600 매</option>
            ...
            <!--5. 플래티넘 -->
			<div id='cntA5' style='visibility:hidden;position:absolute;'>
			 &nbsp; <select name="cnt5" class="input"  bgcolor=white onchange="calc(this);">
              <option selected>:: 수량 ::</option>
              <option value="200" >200 매</option>
              <option value="400" >400 매</option>
              <option value="600" >600 매</option>
            ...
            <input name="cntchk" type="hidden" id="cntchk"></td>
        </tr>
        ...
        <tr> 
          ...
          <td bgcolor="#FFFFFF"> &nbsp; <input name="price" type="text" id="price" style="text-align:right">
            원 &nbsp;&nbsp;&nbsp;
            <select name="num" id="num" onchange="calc()">
			  <? for ($i=1;$i<50;$i++){  ?>
      ...
      <table width="692" border="0" cellpadding="0" cellspacing="1" bgcolor="#D7D7D7">
        ...
        <tr> 
          <td height="25" bgcolor="#FFFFFF"><div align="left"> <font color="#666666">&nbsp; 
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- 인쇄만 의뢰시 파일첨부하여 
              주시면 인쇄할 수 있는 파일인지 확인 후 작업 진행됩니다.</font></div></td>
        </tr>
        <tr> 
          <td height="25" bgcolor="#FFFFFF"><div align="left"> <font color="#666666">&nbsp; 
              <input type="radio" name="design" value="a">
              디자인 수정 및 편집 : 8,000원 (모든파일의 내용을 일부 편집/수정 합니다)</font></div></td>
        </tr>
        <tr> 
          <td height="25" bgcolor="#FFFFFF"><div align="left"> <font color="#666666">&nbsp; 
              <input type="radio" name="design" value="b">
              단면 디자인 의뢰 : 8,000원</font></div></td>
        </tr>
        <tr> 
          <td height="25" bgcolor="#FFFFFF"><div align="left"> <font color="#666666">&nbsp; 
