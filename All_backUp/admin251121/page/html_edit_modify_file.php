...
<input type="radio" onClick="javascript:window.location.href='<?echo("$PHP_SELF");?>?mode=<?echo("$mode");?>&code=file&no=<?echo("$no");?>';"  name='style' value='file' <?if($code=="file"){echo("checked");}else{if($TT_style=="file"){echo("checked");}}?>>파일(업로드)로 입력
</td>
</tr>
...
<?php if($TT_style=="file"){echo("<BR><BR><b>현재 업로드되어있는 파일명: $TT_connent</b>");}
?>
</td>
</tr>
