...
<table width="600"  align="center"  border="0" cellspacing="1" cellpadding="3" bgcolor="#c5c5c5"
 font-color="#000000">
<form action=basket_postaa.php method=post> 
  ...
  <tr bgcolor="#E1E1FF" >
    ...
    <td width="500" bgcolor="#FFFFFF"><select name="jong" value="<?php echo $jong?>">
      ...
      <option value="jsp 금지">금지스티커 </option>
      <option value="jsp 롤형">롤스티커 </option>
      <option value="jsp 크라">크라프트스티커 </option>
    </select>
  ...
  <tr bgcolor="#FFFFFF">
    ...
    가로나 세로가 <span class="style2">50mm이하 크기</span>는 도무송가격이 적용됩니다
    <tr bgcolor="#FFFFFF">    
	...
	<td><select name="mesu" value="<?php echo $mesu?>">
	  ...
	  <span class="style2">10,000매 이상</span>은 별도견적
    <tr bgcolor="#FFFFFF">
  ...
  <select name="domusong">
    ...
    <option value="19000 복잡">모양(B)복잡 </option>
  </select> 
  (둥근사각,원,타원)선택
	<tr bgcolor="#FFFFFF">
...
<div align="center" class="center1">
 <a href=basket.php><img src="img/order.gif" width="99" height="31" border="0" /></a>        <br>
    <span class="style7"><span class="style8">택배비는착불</span>입니다. 모든 작업은 <strong>입금 후에 진행</strong>됩니다. <br>
    <br>
  주문하기를 누르시면<span class="style8"> 파일올리기</span>가 맨아래에 보입니다.</span>
</div>
 <span class="center1">
<?    
         // $now=time();
