...
<td><INPUT TYPE="text" NAME="quantity" size=20 maxLength='20' <?if($code=="Modify"){echo("value='$MlangPrintAutoFildView_quantity'");}?>>부</td>
</tr>
...
<tr>
<td colspan=2 align='center'>* 기타는숫자 수치을 9999 로 입력해주세요</td>
</tr>
