...
alert("<?=$View_TtableC?> [스티카종류] 을 선택하여주세요!!");
f.RadOne.focus();
return false;
}

if (f.myList.value == "#" || f.myList.value == "==================") {
alert("<?=$View_TtableC?>[규격] 을 선택하여주세요!!");
f.myList.focus();
return false;
}
...
$query ="UPDATE $TABLE SET style='$RadOne', Section='$myList', quantity='$quantity', money='$money', DesignMoney='$TDesignMoney' WHERE no='$no'";
