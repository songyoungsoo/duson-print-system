...
<?php $query= mysqli_query($db, "select * from zipcode where SIDO like '%$zip_search%' or GUGUN like '%$zip_search%' or DONG like '%$zip_search%'");
...
$result= mysqli_query($db, "select * from zipcode where SIDO like '%$zip_search%' or GUGUN like '%$zip_search%' or DONG like '%$zip_search%' order by NO desc limit $offset,$listcut");
