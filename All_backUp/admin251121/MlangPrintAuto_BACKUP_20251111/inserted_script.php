...
<option value='#'>:::::: 선택하세요 ::::::</option>
<?if($code=="Modify"){if($MlangPrintAutoFildView_TreeSelect){echo("<option value='$MlangPrintAutoFildView_TreeSelect' selected style='font-size:10pt; background-color:#429EB2; color:#FFFFFF;'>");?><?php include"../../db.php";
...
<select name=myList>
<option value='#'>:::::: 선택하세요 ::::::</option>
<?if($code=="Modify"){if($MlangPrintAutoFildView_Section){echo("<option value='$MlangPrintAutoFildView_Section' selected style='font-size:10pt; background-color:#429EB2; color:#FFFFFF;'>");?><?php include"../../db.php";
