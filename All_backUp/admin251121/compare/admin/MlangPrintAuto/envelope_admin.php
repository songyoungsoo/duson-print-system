...
alert("<?=$View_TtableC?> [구분] 을 선택하여주세요!!");
f.RadOne.focus();
return false;
}
...
<td>
<select name="POtype">
<option value='2' <?if($MlangPrintAutoFildView_POtype=="2"){echo("selected style='font-size:10pt; background-color:#429EB2; color:#FFFFFF;'");}?>>마스터2도</option>
<option value='1' <?if($MlangPrintAutoFildView_POtype=="1"){echo("selected style='font-size:10pt; background-color:#429EB2; color:#FFFFFF;'");}?>>마스터1도</option>
<option value='3' <?if($MlangPrintAutoFildView_POtype=="3"){echo("selected style='font-size:10pt; background-color:#429EB2; color:#FFFFFF;'");}?>>칼라4도(옵셋)</option>
</select>
</td>
</tr>		
...
<td><INPUT TYPE="text" NAME="quantity" size=20 maxLength='20' <?if($code=="Modify"){echo("value='$MlangPrintAutoFildView_quantity'");}?>>매</td>
</tr>
