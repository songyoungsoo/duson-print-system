...
$ViewBiz_particulars_admin= mysqli_query($db, "select * from MlangWebOffice_Biz_particulars_admin where no='$no'");
// ⚠️  에러 처리 권장: mysqli_error() 사용을 고려하세요

$RowBiz_particulars_admin= mysqli_fetch_array($ViewBiz_particulars_admin);
