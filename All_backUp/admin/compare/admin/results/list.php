...
<select name='item'>
<option value='text'>기본 텍스트형식</option>
<option value='photo'>기본 PHOTO형식</option>
<option value='seoulfireworks'>서울화약 형식</option>
<option value='seoulfireworks2'>서울화약 형식-2</option>
</select>
...
<td align=center>
<select name='item'>
<option value='text' <?if($row[item]=="text"){echo("selected style='background-color:#429EB2; color:#FFFFFF;'");}?>>기본 텍스트형식</option>
<option value='photo' <?if($row[item]=="photo"){echo("selected style='background-color:#429EB2; color:#FFFFFF;'");}?>>기본 PHOTO형식</option>
<option value='seoulfireworks' <?if($row[item]=="seoulfireworks"){echo("selected style='background-color:#429EB2; color:#FFFFFF;'");}?>>서울화약 형식</option>
<option value='seoulfireworks2' <?if($row[item]=="seoulfireworks2"){echo("selected style='background-color:#429EB2; color:#FFFFFF;'");}?>>서울화약 형식-2</option>
</select>
</td>	
