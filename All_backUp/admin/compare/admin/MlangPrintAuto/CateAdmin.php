...
<?if($ACate){?><INPUT TYPE="hidden" name='ACate' value='<?=$ACate?>'><?}?>
<?if($ATreeNo){?><INPUT TYPE="hidden" name='ATreeNo' value='<?=$ATreeNo?>'><?}?>
...
mysql_query("DELETE FROM $GGTABLE WHERE BigNo='$no'");
mysql_query("DELETE FROM $GGTABLE WHERE no='$no'");
mysql_close();
