...
<tr>
<td bgcolor='#<?=$Bgcolor1?>' width=100 class='Left1' align=right>인쇄색상&nbsp;&nbsp;</td>
<td>
...
<tr>
<td bgcolor='#<?=$Bgcolor1?>' width=100 class='Left1' align=right>종이종류&nbsp;&nbsp;</td>
<td>
<select name=myListTreeSelect>
<option value='#'>:::::: 선택하세요 ::::::</option>
<?if($code=="Modify"){if($MlangPrintAutoFildView_TreeSelect){echo("<option value='$MlangPrintAutoFildView_TreeSelect' selected style='font-size:10pt; background-color:#429EB2; color:#FFFFFF;'>");?><? include"../../db.php";
$result=mysql_query("select * from $GGTABLE where no='$MlangPrintAutoFildView_TreeSelect'",$db);
...
<tr>
<td bgcolor='#<?=$Bgcolor1?>' width=100 class='Left1' align=right>종이규격&nbsp;&nbsp;</td>
<td>
<select name=myList>
<option value='#'>:::::: 선택하세요 ::::::</option>
<?if($code=="Modify"){if($MlangPrintAutoFildView_Section){echo("<option value='$MlangPrintAutoFildView_Section' selected style='font-size:10pt; background-color:#429EB2; color:#FFFFFF;'>");?><? include"../../db.php";
$result=mysql_query("select * from $GGTABLE where no='$MlangPrintAutoFildView_Section'",$db);
$row= mysql_fetch_array($result);
if($row){ echo("$row[title]"); } mysql_close($db); 
?><?echo("</option>");}}?>
</select>
