...
include"../../db.php";
$result= mysql_query("select * from MlangOrder_PrintAuto_OfferOrder where no='$no'",$db);
...
include"../../db.php";
$result = mysql_query("DELETE FROM MlangOrder_PrintAuto_OfferOrder WHERE no='$no'");
mysql_close();
