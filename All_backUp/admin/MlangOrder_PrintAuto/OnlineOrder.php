...
include"../../db.php";
$result = mysqli_query($db, "DELETE FROM MlangOrder WHERE no='$no'");
mysqli_close($db);
...
<td align=center><input type='button' onClick="javascript:popup=window.open('<?=$PHP_SELF?>?mode=view&no=<?=$row[no]?>', 'MlangOrder','width=600,height=430,top=0,left=0,menubar=no,resizable=no,statusbar=no,scrollbars=yes,toolbar=no'); popup.focus();" value=' 자세한정보보기 '></font></td>
<td align=center>
