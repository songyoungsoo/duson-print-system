...
$MlangPrintAutoFildView_DesignMoney = $MlangPrintAutoFildView_DesignMoney ?? '';
?>
<head>
<style>
...
<td><INPUT TYPE="text" NAME="quantity" size=20 maxLength='20' <?if($code=="Modify"){echo("value='$MlangPrintAutoFildView_quantity'");}?>>권</td>
</tr>

<!---------
<tr>
<td bgcolor='#<?=$Bgcolor1?>' width=100 class='Left1' align=right>수량(옆)&nbsp;&nbsp;</td>
<td><INPUT TYPE="text" NAME="quantityTwo" size=20 maxLength='20' <?if($code=="Modify"){echo("value='$MlangPrintAutoFildView_quantityTwo'");}?>>장</td>
</tr>--------------->
