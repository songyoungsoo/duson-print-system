...
$MlangPrintAutoFildView_quantityTwo = $MlangPrintAutoFildView_quantityTwo ?? '';
...
<td><INPUT TYPE="text" NAME="quantity" size=20 maxLength='20' <?if($code=="Modify"){echo("value='$MlangPrintAutoFildView_quantity'");}?>>연</td>
</tr>
