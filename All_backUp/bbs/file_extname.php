<?php
$FileExtName = substr(strrchr($BbsViewmlang_bbs_file,"."),1);
...
echo("<embed src='$Homedir/bbs/upload/$table/$BbsViewmlang_bbs_file'>");
}
/////////////////////////////////////////////////////////////////////////
...
<param name="FileName" value="<?php echo("$Homedir/bbs/upload/$table/$BbsViewmlang_bbs_file");?>">
