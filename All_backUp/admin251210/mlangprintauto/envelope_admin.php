...
<td>
<select name="POtype">
<option value='2' <?php if($MlangPrintAutoFildView_POtype=="2"){echo("selected style='font-size:10pt; background-color:#429EB2; color:#FFFFFF;'");}?>>마스터2도</option>
<option value='1' <?php if($MlangPrintAutoFildView_POtype=="1"){echo("selected style='font-size:10pt; background-color:#429EB2; color:#FFFFFF;'");}?>>마스터1도</option>
<option value='3' <?php if($MlangPrintAutoFildView_POtype=="3"){echo("selected style='font-size:10pt; background-color:#429EB2; color:#FFFFFF;'");}?>>칼라4도(옵셋)</option>
</select>
</td>
</tr>		
