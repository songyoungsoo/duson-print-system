...
if($AdminCode21=="form"){
include"../title.php";
$result= mysqli_query($db, "select * from $table where Mlang_bbs_no='$no'");
...
////////////// 새로 추가한 기능 BBSTOP /////////////////////////
$BBS_TOPresult= mysqli_query($db, "select * from BBS_TOP where BBS_Table='$BBS_Table' and BBS_No='$no'");
