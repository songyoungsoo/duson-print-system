...
if (!$cfgRelation['relwork']) {
    echo sprintf($strNotSet, 'relation', 'config.inc.php') . '<br />' . "\n"
         . '<a href="./Documentation.php#relation" target="documentation">' . $strDocu . '</a>' . "\n";
    exit();
}

if (!$cfgRelation['displaywork']) {
    echo sprintf($strNotSet, 'table_info', 'config.inc.php') . '<br />' . "\n"
         . '<a href="./Documentation.php#table_info" target="documentation">' . $strDocu . '</a>' . "\n";
    exit();
}

if (!isset($cfgRelation['table_coords'])){
    echo sprintf($strNotSet, 'table_coords', 'config.inc.php') . '<br />' . "\n"
         . '<a href="./Documentation.php#table_coords" target="documentation">' . $strDocu . '</a>' . "\n";
    exit();
}
if (!isset($cfgRelation['pdf_pages'])) {
    echo sprintf($strNotSet, 'pdf_page', 'config.inc.php') . '<br />' . "\n"
         . '<a href="./Documentation.php#pdf_pages" target="documentation">' . $strDocu . '</a>' . "\n";
    exit();
}
...
if ($cfgRelation['pdfwork']) {
    ...
    if ($page_rs && mysqli_num_rows($page_rs) > 0) {
        ?>
