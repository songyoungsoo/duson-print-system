...
<body class="ncrflambeau-page<?php echo $body_class; ?>">
        ...
        <div class="product-content">
            ...
            <aside class="product-calculator" aria-label="실시간 견적 계산기">
                ...
                <form id="ncr-quote-form" method="post">
                    ...
                    <!-- 🆕 추가 옵션 섹션 (견적서 모달에서는 숨김) -->
                    <div class="premium-options-section" id="premiumOptionsSection" style="margin-top: 15px;<?php echo $is_quotation_mode ? ' display: none;' : ''; ?>">
                        <!-- 한 줄 체크박스 헤더 -->
    ...
    window.sendToQuotation = function() {
        ...
        try {
            ...
            const fsdText = myFsdSelect ? myFsdSelect.options[myFsdSelect.selectedIndex].text : '';
            const colorText = pnTypeSelect ? pnTypeSelect.options[pnTypeSelect.selectedIndex].text : '';
            ...
            // 규격 문자열 생성
            let specification = `${typeText} / ${fsdText} / ${colorText} / ${quantityText} / ${ordertypeText}`.trim();
            ...
            // 수량 값 추출
            const quantityValue = parseInt(myAmountSelect.value) || 1;
