...
<?php if (!$is_quotation_mode): ?>
            ...
            <section class="product-gallery" style="position: relative;">
                ...
                <div id="sizePreviewContainer" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 500px; height: 400px; background: rgba(255,255,255,0.97); border-radius: 12px; overflow: hidden; display: none; z-index: 100; box-shadow: 0 8px 32px rgba(0,0,0,0.25); border: 2px solid #667eea;">
                    ...
                    <!-- 템플릿 다운로드 버튼 섹션 (플로팅 이미지 아래) -->
                    <div id="templateDownloadButtons" style="display: none; position: absolute; bottom: 10px; left: 0; right: 0; text-align: center; padding: 10px;">
                        <div style="display: flex; justify-content: center; gap: 12px; flex-wrap: wrap;">
                            <button type="button" onclick="downloadSVGTemplate()" style="background: linear-gradient(135deg, #28a745 0%, #20c997 100%); color: white; padding: 10px 18px; border-radius: 25px; font-size: 12px; cursor: pointer; font-weight: 600; border: none; box-shadow: 0 3px 8px rgba(40, 167, 69, 0.3); transition: all 0.3s;">
                                📄 SVG 템플릿
                            </button>
                            <button type="button" onclick="downloadAITemplateFromPreview()" style="background: linear-gradient(135deg, #ff6b35 0%, #f7931e 100%); color: white; padding: 10px 18px; border-radius: 25px; font-size: 12px; cursor: pointer; font-weight: 600; border: none; box-shadow: 0 3px 8px rgba(255, 107, 53, 0.3); transition: all 0.3s;">
                                🎨 AI 템플릿
                            </button>
                            <button type="button" onclick="downloadCanvasSnapshot()" style="background: linear-gradient(135deg, #6f42c1 0%, #a855f7 100%); color: white; padding: 10px 18px; border-radius: 25px; font-size: 12px; cursor: pointer; font-weight: 600; border: none; box-shadow: 0 3px 8px rgba(111, 66, 193, 0.3); transition: all 0.3s;">
                                🖼️ 한글 가이드 (PNG)
                            </button>
                        </div>
                        <div style="font-size: 10px; color: #888; margin-top: 8px; text-align: center;">
                            💡 AI/SVG는 영어, 한글 가이드는 PNG 이미지로 참조하세요
                        </div>
                        <div id="downloadProgressBar" style="display: none; margin-top: 10px;">
                            <div style="background: #e9ecef; border-radius: 10px; height: 8px; overflow: hidden;">
                                <div id="downloadProgress" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); height: 100%; width: 0%; transition: width 0.3s ease;"></div>
                            </div>
                            <div style="font-size: 10px; color: #666; margin-top: 4px;">다운로드 준비 중...</div>
                        </div>
                    </div>
                </div>
