...
<?php endif; ?>
    ...
    <script>
        ...
        function updatePriceDisplay(priceData) {
            ...
            // DOM 요소 존재 확인 (견적서 모달에서는 uploadButton 없을 수 있음)
            ...
            if (priceData && priceData.price) {
                ...
                // 업로드/주문 버튼 표시 (견적서 모달에서는 없을 수 있음)
        ...
        function autoCalculatePrice() {
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    window.currentPriceData = data.data; // 견적서 모달 호환성
  ...
  <g transform="translate(${svgWidth / 2}, ${svgHeight - 20})" font-family="GulimChe, Gulim, Arial, sans-serif" text-anchor="middle" font-size="3.5">
    ...
    <g transform="translate(50, 10)">
      ...
      <text x="12" y="1" fill="#666" text-anchor="start">안전선 -${safety}mm</text>
        ...
        // 실제 계산 함수를 직접 호출하도록 수정 (무한 루프 방지)
        // autoCalculatePrice는 655번째 줄에 이미 정의됨
        // window에 명시적으로 할당 (전역 접근 가능하도록)
