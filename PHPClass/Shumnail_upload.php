<?php
<?php
//$ImgServerDir="/home/hosting_users/mlangcafe/www/PHPClass/upload/";
//$max_width = $ImgServerDirWidth; // 저장될 이미지 가로
//$max_height = $ImgServerDirHeight; // 저장될 이미지 세로
if( $user_file ){

$save_filename = $user_file_name;
$save_path = "$ImgServerDir"; 
$max_width = $ImgServerDirWidth; 
$max_height = $ImgServerDirHeight; 

thumnail($user_file, $save_filename, $save_path, $max_width, $max_height); // 셈네일 이미지 저장
}
